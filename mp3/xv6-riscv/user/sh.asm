...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      32:	32278793          	addi	a5,a5,802 # 2350 <schedule_rm+0x2e4>
      36:	97ba                	add	a5,a5,a4
      38:	439c                	lw	a5,0(a5)
      3a:	0007871b          	sext.w	a4,a5
      3e:	00002797          	auipc	a5,0x2
      42:	31278793          	addi	a5,a5,786 # 2350 <schedule_rm+0x2e4>
      46:	97ba                	add	a5,a5,a4
      48:	8782                	jr	a5
  default:
    panic("runcmd");
      4a:	00002517          	auipc	a0,0x2
      4e:	2d650513          	addi	a0,a0,726 # 2320 <schedule_rm+0x2b4>
  ...
  case EXEC:
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      98:	29458593          	addi	a1,a1,660 # 2328 <schedule_rm+0x2bc>
      9c:	4509                	li	a0,2
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ea:	25258593          	addi	a1,a1,594 # 2338 <schedule_rm+0x2cc>
      ee:	4509                	li	a0,2
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     174:	1d850513          	addi	a0,a0,472 # 2348 <schedule_rm+0x2dc>
...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
     ...
     298:	0d458593          	addi	a1,a1,212 # 2368 <schedule_rm+0x2fc>
     29c:	4509                	li	a0,2
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     314:	06050513          	addi	a0,a0,96 # 2370 <schedule_rm+0x304>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     378:	11c50513          	addi	a0,a0,284 # 2490 <buf.0>
     ...
     390:	10470713          	addi	a4,a4,260 # 2490 <buf.0>
     ...
     3a2:	0f578793          	addi	a5,a5,245 # 2493 <buf.0+0x3>
     3a6:	853e                	mv	a0,a5
     ...
     3ba:	0dd78793          	addi	a5,a5,221 # 2493 <buf.0+0x3>
     3be:	863e                	mv	a2,a5
     3c0:	00002597          	auipc	a1,0x2
     3c4:	fb858593          	addi	a1,a1,-72 # 2378 <schedule_rm+0x30c>
     3c8:	4509                	li	a0,2
    ...
    if(fork1() == 0)
     ...
     3e4:	0b050513          	addi	a0,a0,176 # 2490 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     40e:	08650513          	addi	a0,a0,134 # 2490 <buf.0>
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
     ...
     43e:	f4e58593          	addi	a1,a1,-178 # 2388 <schedule_rm+0x31c>
     442:	4509                	li	a0,2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     47e:	f1650513          	addi	a0,a0,-234 # 2390 <schedule_rm+0x324>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a4:	de050513          	addi	a0,a0,-544 # 2480 <whitespace>
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     7a0:	ce450513          	addi	a0,a0,-796 # 2480 <whitespace>
     ...
     7be:	cce50513          	addi	a0,a0,-818 # 2488 <symbols>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     810:	c7450513          	addi	a0,a0,-908 # 2480 <whitespace>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     87c:	c0850513          	addi	a0,a0,-1016 # 2480 <whitespace>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     916:	a8660613          	addi	a2,a2,-1402 # 2398 <schedule_rm+0x32c>
  ...
  if(s != es){
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     93e:	a6658593          	addi	a1,a1,-1434 # 23a0 <schedule_rm+0x334>
     942:	4509                	li	a0,2
     944:	00001097          	auipc	ra,0x1
     948:	f96080e7          	jalr	-106(ra) # 18da <fprintf>
    panic("syntax");
     94c:	00002517          	auipc	a0,0x2
     950:	a6450513          	addi	a0,a0,-1436 # 23b0 <schedule_rm+0x344>
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     9c6:	9f660613          	addi	a2,a2,-1546 # 23b8 <schedule_rm+0x34c>
  ...
  if(peek(ps, es, ";")){
     ...
     9e2:	9e260613          	addi	a2,a2,-1566 # 23c0 <schedule_rm+0x354>
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     a68:	96460613          	addi	a2,a2,-1692 # 23c8 <schedule_rm+0x35c>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     b22:	8b250513          	addi	a0,a0,-1870 # 23d0 <schedule_rm+0x364>
  ...
  while(peek(ps, es, "<>")){
     ...
     bd6:	81e60613          	addi	a2,a2,-2018 # 23f0 <schedule_rm+0x384>
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     c12:	7ea60613          	addi	a2,a2,2026 # 23f8 <schedule_rm+0x38c>
    ...
    panic("parseblock");
     ...
     c2e:	7d650513          	addi	a0,a0,2006 # 2400 <schedule_rm+0x394>
  ...
  if(!peek(ps, es, ")"))
     ...
     c66:	7ae60613          	addi	a2,a2,1966 # 2410 <schedule_rm+0x3a4>
    ...
    panic("syntax - missing )");
     ...
     c82:	79a50513          	addi	a0,a0,1946 # 2418 <schedule_rm+0x3ac>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     cdc:	72060613          	addi	a2,a2,1824 # 23f8 <schedule_rm+0x38c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     d78:	63c50513          	addi	a0,a0,1596 # 23b0 <schedule_rm+0x344>
    ...
    if(argc >= MAXARGS)
     ...
     dc6:	66e50513          	addi	a0,a0,1646 # 2430 <schedule_rm+0x3c4>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     dee:	65660613          	addi	a2,a2,1622 # 2440 <schedule_rm+0x3d4>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     e66:	5e678793          	addi	a5,a5,1510 # 2448 <schedule_rm+0x3dc>
     e6a:	97ba                	add	a5,a5,a4
     e6c:	439c                	lw	a5,0(a5)
     e6e:	0007871b          	sext.w	a4,a5
     e72:	00001797          	auipc	a5,0x1
     e76:	5d678793          	addi	a5,a5,1494 # 2448 <schedule_rm+0x3dc>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1554:	f1868693          	addi	a3,a3,-232 # 2468 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    162e:	e3e70713          	addi	a4,a4,-450 # 2468 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    17ee:	c7678793          	addi	a5,a5,-906 # 2460 <schedule_rm+0x3f4>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    199a:	b7278793          	addi	a5,a5,-1166 # 2508 <freep>
  ...
  freep = p;
    ...
    1a92:	a7a78793          	addi	a5,a5,-1414 # 2508 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1b14:	9f878793          	addi	a5,a5,-1544 # 2508 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b46:	9c678793          	addi	a5,a5,-1594 # 2508 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c04:	90878793          	addi	a5,a5,-1784 # 2508 <freep>
    ...
    1c1a:	8f278793          	addi	a5,a5,-1806 # 2508 <freep>
...
struct threads_sched_result schedule_default(struct threads_sched_args args)
{
    ...
    1d0a:	5398                	lw	a4,32(a5)
    1d0c:	fe843783          	ld	a5,-24(s0)
    1d10:	539c                	lw	a5,32(a5)
    ...
    1d7c:	fc043703          	ld	a4,-64(s0)
    1d80:	fc843783          	ld	a5,-56(s0)
    1d84:	863a                	mv	a2,a4
    1d86:	86be                	mv	a3,a5
    1d88:	8732                	mv	a4,a2
    1d8a:	87b6                	mv	a5,a3
    ...
    1d8c:	853a                	mv	a0,a4
    1d8e:	85be                	mv	a1,a5
    1d90:	6426                	ld	s0,72(sp)
    1d92:	6486                	ld	s1,64(sp)
    1d94:	6161                	addi	sp,sp,80
    1d96:	8082                	ret

0000000000001d98 <schedule_edf>:

/* Earliest-Deadline-First scheduling */
struct threads_sched_result schedule_edf(struct threads_sched_args args)
{   
    1d98:	7171                	addi	sp,sp,-176
    1d9a:	f522                	sd	s0,168(sp)
    1d9c:	f126                	sd	s1,160(sp)
    1d9e:	1900                	addi	s0,sp,176
    1da0:	84aa                	mv	s1,a0
    int is_miss = 0;
    1da2:	fe042623          	sw	zero,-20(s0)
    struct thread *tws_deadline = NULL, *tws_id = NULL;
    1da6:	fe043023          	sd	zero,-32(s0)
    1daa:	fc043c23          	sd	zero,-40(s0)
    struct thread *th = NULL;
    1dae:	fc043823          	sd	zero,-48(s0)
    ...
    1dc2:	fcf43823          	sd	a5,-48(s0)
    1dc6:	a895                	j	1e3a <schedule_edf+0xa2>
        if(args.current_time + th->remaining_time > th->current_deadline){
    1dc8:	4098                	lw	a4,0(s1)
    1dca:	fd043783          	ld	a5,-48(s0)
    1dce:	47fc                	lw	a5,76(a5)
    1dd0:	9fb9                	addw	a5,a5,a4
    1dd2:	0007871b          	sext.w	a4,a5
    1dd6:	fd043783          	ld	a5,-48(s0)
    1dda:	4bbc                	lw	a5,80(a5)
    1ddc:	00e7d563          	bge	a5,a4,1de6 <schedule_edf+0x4e>
            is_miss = 1;
    1de0:	4785                	li	a5,1
    1de2:	fef42623          	sw	a5,-20(s0)
        }
    ...
    1de6:	fe043783          	ld	a5,-32(s0)
    1dea:	cb8d                	beqz	a5,1e1c <schedule_edf+0x84>
    1dec:	fd043783          	ld	a5,-48(s0)
    1df0:	4bb8                	lw	a4,80(a5)
    1df2:	fe043783          	ld	a5,-32(s0)
    1df6:	4bbc                	lw	a5,80(a5)
    1df8:	02f74263          	blt	a4,a5,1e1c <schedule_edf+0x84>
    1dfc:	fd043783          	ld	a5,-48(s0)
    1e00:	4bb8                	lw	a4,80(a5)
    1e02:	fe043783          	ld	a5,-32(s0)
    1e06:	4bbc                	lw	a5,80(a5)
    1e08:	00f71e63          	bne	a4,a5,1e24 <schedule_edf+0x8c>
    1e0c:	fd043783          	ld	a5,-48(s0)
    1e10:	5398                	lw	a4,32(a5)
    1e12:	fe043783          	ld	a5,-32(s0)
    1e16:	539c                	lw	a5,32(a5)
    1e18:	00f75663          	bge	a4,a5,1e24 <schedule_edf+0x8c>
            tws_deadline = th;
    1e1c:	fd043783          	ld	a5,-48(s0)
    1e20:	fef43023          	sd	a5,-32(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1e24:	fd043783          	ld	a5,-48(s0)
    1e28:	779c                	ld	a5,40(a5)
    1e2a:	f6f43823          	sd	a5,-144(s0)
    1e2e:	f7043783          	ld	a5,-144(s0)
    1e32:	fd878793          	addi	a5,a5,-40
    1e36:	fcf43823          	sd	a5,-48(s0)
    1e3a:	fd043783          	ld	a5,-48(s0)
    1e3e:	02878713          	addi	a4,a5,40
    1e42:	649c                	ld	a5,8(s1)
    1e44:	f8f712e3          	bne	a4,a5,1dc8 <schedule_edf+0x30>
        }
    }
    ...
    1e4c:	18078063          	beqz	a5,1fcc <schedule_edf+0x234>
        if(!is_miss){
    1e50:	fec42783          	lw	a5,-20(s0)
    1e54:	2781                	sext.w	a5,a5
    1e56:	e3ed                	bnez	a5,1f38 <schedule_edf+0x1a0>
            r.scheduled_thread_list_member = &tws_deadline->thread_list;
    1e58:	fe043783          	ld	a5,-32(s0)
    1e5c:	02878793          	addi	a5,a5,40
    1e60:	f4f43823          	sd	a5,-176(s0)
            struct release_queue_entry *rth;
            struct thread *find = NULL;
    1e64:	fc043023          	sd	zero,-64(s0)
            list_for_each_entry(rth, args.release_queue, thread_list){
    1e68:	689c                	ld	a5,16(s1)
    1e6a:	639c                	ld	a5,0(a5)
    1e6c:	f8f43023          	sd	a5,-128(s0)
    1e70:	f8043783          	ld	a5,-128(s0)
    1e74:	17e1                	addi	a5,a5,-8
    1e76:	fcf43423          	sd	a5,-56(s0)
    1e7a:	a88d                	j	1eec <schedule_edf+0x154>
    ...
    1e7c:	fc843783          	ld	a5,-56(s0)
    1e80:	639c                	ld	a5,0(a5)
    1e82:	4bb8                	lw	a4,80(a5)
    1e84:	fc843783          	ld	a5,-56(s0)
    1e88:	639c                	ld	a5,0(a5)
    1e8a:	43fc                	lw	a5,68(a5)
    1e8c:	9fb9                	addw	a5,a5,a4
    1e8e:	0007871b          	sext.w	a4,a5
    1e92:	fe043783          	ld	a5,-32(s0)
    1e96:	4bbc                	lw	a5,80(a5)
    1e98:	04f75063          	bge	a4,a5,1ed8 <schedule_edf+0x140>
    1e9c:	fc043783          	ld	a5,-64(s0)
    1ea0:	c79d                	beqz	a5,1ece <schedule_edf+0x136>
    1ea2:	fc843783          	ld	a5,-56(s0)
    1ea6:	639c                	ld	a5,0(a5)
    1ea8:	4bb8                	lw	a4,80(a5)
    1eaa:	fc843783          	ld	a5,-56(s0)
    1eae:	639c                	ld	a5,0(a5)
    1eb0:	43fc                	lw	a5,68(a5)
    1eb2:	9fb9                	addw	a5,a5,a4
    1eb4:	0007859b          	sext.w	a1,a5
    1eb8:	fc043783          	ld	a5,-64(s0)
    1ebc:	4bb8                	lw	a4,80(a5)
    1ebe:	fc043783          	ld	a5,-64(s0)
    1ec2:	43fc                	lw	a5,68(a5)
    1ec4:	9fb9                	addw	a5,a5,a4
    1ec6:	2781                	sext.w	a5,a5
    1ec8:	872e                	mv	a4,a1
    1eca:	00f75763          	bge	a4,a5,1ed8 <schedule_edf+0x140>
                    find = rth->thrd;
    1ece:	fc843783          	ld	a5,-56(s0)
    1ed2:	639c                	ld	a5,0(a5)
    1ed4:	fcf43023          	sd	a5,-64(s0)
            list_for_each_entry(rth, args.release_queue, thread_list){
    1ed8:	fc843783          	ld	a5,-56(s0)
    1edc:	679c                	ld	a5,8(a5)
    1ede:	f6f43c23          	sd	a5,-136(s0)
    1ee2:	f7843783          	ld	a5,-136(s0)
    1ee6:	17e1                	addi	a5,a5,-8
    1ee8:	fcf43423          	sd	a5,-56(s0)
    1eec:	fc843783          	ld	a5,-56(s0)
    1ef0:	00878713          	addi	a4,a5,8
    1ef4:	689c                	ld	a5,16(s1)
    1ef6:	f8f713e3          	bne	a4,a5,1e7c <schedule_edf+0xe4>
                }
            }
    ...
    1efe:	cf89                	beqz	a5,1f18 <schedule_edf+0x180>
    1f00:	4098                	lw	a4,0(s1)
    1f02:	fe043783          	ld	a5,-32(s0)
    1f06:	47fc                	lw	a5,76(a5)
    1f08:	9fb9                	addw	a5,a5,a4
    1f0a:	0007871b          	sext.w	a4,a5
    1f0e:	fc043783          	ld	a5,-64(s0)
    1f12:	4bbc                	lw	a5,80(a5)
    1f14:	00e7c863          	blt	a5,a4,1f24 <schedule_edf+0x18c>
    1f18:	fe043783          	ld	a5,-32(s0)
    1f1c:	47fc                	lw	a5,76(a5)
    1f1e:	f4f42c23          	sw	a5,-168(s0)
    1f22:	aa39                	j	2040 <schedule_edf+0x2a8>
            else{
    ...
    1f28:	4bb8                	lw	a4,80(a5)
    1f2a:	409c                	lw	a5,0(s1)
    1f2c:	40f707bb          	subw	a5,a4,a5
    1f30:	2781                	sext.w	a5,a5
    1f32:	f4f42c23          	sw	a5,-168(s0)
    1f36:	a229                	j	2040 <schedule_edf+0x2a8>
            }
        }
        else{
            list_for_each_entry(th, args.run_queue, thread_list) {
    1f38:	649c                	ld	a5,8(s1)
    1f3a:	639c                	ld	a5,0(a5)
    1f3c:	f8f43823          	sd	a5,-112(s0)
    1f40:	f9043783          	ld	a5,-112(s0)
    1f44:	fd878793          	addi	a5,a5,-40
    1f48:	fcf43823          	sd	a5,-48(s0)
    1f4c:	a089                	j	1f8e <schedule_edf+0x1f6>
                if (tws_id == NULL || (args.current_time >= th->current_deadline && th->ID < tws_id->ID)) {
    1f4e:	fd843783          	ld	a5,-40(s0)
    1f52:	cf99                	beqz	a5,1f70 <schedule_edf+0x1d8>
    1f54:	4098                	lw	a4,0(s1)
    1f56:	fd043783          	ld	a5,-48(s0)
    1f5a:	4bbc                	lw	a5,80(a5)
    1f5c:	00f74e63          	blt	a4,a5,1f78 <schedule_edf+0x1e0>
    1f60:	fd043783          	ld	a5,-48(s0)
    1f64:	5398                	lw	a4,32(a5)
    1f66:	fd843783          	ld	a5,-40(s0)
    1f6a:	539c                	lw	a5,32(a5)
    1f6c:	00f75663          	bge	a4,a5,1f78 <schedule_edf+0x1e0>
                    tws_id = th;
    1f70:	fd043783          	ld	a5,-48(s0)
    1f74:	fcf43c23          	sd	a5,-40(s0)
            list_for_each_entry(th, args.run_queue, thread_list) {
    1f78:	fd043783          	ld	a5,-48(s0)
    1f7c:	779c                	ld	a5,40(a5)
    1f7e:	f8f43423          	sd	a5,-120(s0)
    1f82:	f8843783          	ld	a5,-120(s0)
    ...
    1f98:	faf71be3          	bne	a4,a5,1f4e <schedule_edf+0x1b6>
                }
            }
            r.scheduled_thread_list_member = &tws_id->thread_list;
    1f9c:	fd843783          	ld	a5,-40(s0)
    1fa0:	02878793          	addi	a5,a5,40
    1fa4:	f4f43823          	sd	a5,-176(s0)
            r.allocated_time = (tws_id->current_deadline - args.current_time < 0)? 0: tws_id->current_deadline - args.current_time;
    1fa8:	fd843783          	ld	a5,-40(s0)
    1fac:	4bb8                	lw	a4,80(a5)
    1fae:	409c                	lw	a5,0(s1)
    1fb0:	40f707bb          	subw	a5,a4,a5
    1fb4:	2781                	sext.w	a5,a5
    1fb6:	873e                	mv	a4,a5
    1fb8:	0007079b          	sext.w	a5,a4
    1fbc:	0007d363          	bgez	a5,1fc2 <schedule_edf+0x22a>
    1fc0:	4701                	li	a4,0
    1fc2:	0007079b          	sext.w	a5,a4
    1fc6:	f4f42c23          	sw	a5,-168(s0)
    1fca:	a89d                	j	2040 <schedule_edf+0x2a8>
        }
        
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    1fcc:	649c                	ld	a5,8(s1)
    1fce:	f4f43823          	sd	a5,-176(s0)
            struct release_queue_entry *rth;
            struct thread *find = NULL;
    1fd2:	fa043823          	sd	zero,-80(s0)
            list_for_each_entry(rth, args.release_queue, thread_list) {
    1fd6:	689c                	ld	a5,16(s1)
    1fd8:	639c                	ld	a5,0(a5)
    1fda:	faf43023          	sd	a5,-96(s0)
    1fde:	fa043783          	ld	a5,-96(s0)
    1fe2:	17e1                	addi	a5,a5,-8
    1fe4:	faf43c23          	sd	a5,-72(s0)
    1fe8:	a825                	j	2020 <schedule_edf+0x288>
            if (find == NULL || (rth->thrd->current_deadline < find->current_deadline)) {
    1fea:	fb043783          	ld	a5,-80(s0)
    1fee:	cb91                	beqz	a5,2002 <schedule_edf+0x26a>
    1ff0:	fb843783          	ld	a5,-72(s0)
    1ff4:	639c                	ld	a5,0(a5)
    1ff6:	4bb8                	lw	a4,80(a5)
    1ff8:	fb043783          	ld	a5,-80(s0)
    1ffc:	4bbc                	lw	a5,80(a5)
    1ffe:	00f75763          	bge	a4,a5,200c <schedule_edf+0x274>
                find = rth->thrd;
    2002:	fb843783          	ld	a5,-72(s0)
    2006:	639c                	ld	a5,0(a5)
    2008:	faf43823          	sd	a5,-80(s0)
            list_for_each_entry(rth, args.release_queue, thread_list) {
    200c:	fb843783          	ld	a5,-72(s0)
    2010:	679c                	ld	a5,8(a5)
    2012:	f8f43c23          	sd	a5,-104(s0)
    2016:	f9843783          	ld	a5,-104(s0)
    201a:	17e1                	addi	a5,a5,-8
    201c:	faf43c23          	sd	a5,-72(s0)
    2020:	fb843783          	ld	a5,-72(s0)
    2024:	00878713          	addi	a4,a5,8
    2028:	689c                	ld	a5,16(s1)
    202a:	fcf710e3          	bne	a4,a5,1fea <schedule_edf+0x252>
            }
        }
        r.allocated_time = find->current_deadline - args.current_time;
    202e:	fb043783          	ld	a5,-80(s0)
    2032:	4bb8                	lw	a4,80(a5)
    2034:	409c                	lw	a5,0(s1)
    2036:	40f707bb          	subw	a5,a4,a5
    203a:	2781                	sext.w	a5,a5
    203c:	f4f42c23          	sw	a5,-168(s0)
    }

    return r;
    2040:	f5043783          	ld	a5,-176(s0)
    2044:	f6f43023          	sd	a5,-160(s0)
    2048:	f5843783          	ld	a5,-168(s0)
    204c:	f6f43423          	sd	a5,-152(s0)
    2050:	f6043703          	ld	a4,-160(s0)
    2054:	f6843783          	ld	a5,-152(s0)
    2058:	863a                	mv	a2,a4
    205a:	86be                	mv	a3,a5
    205c:	8732                	mv	a4,a2
    205e:	87b6                	mv	a5,a3
    ...
    2060:	853a                	mv	a0,a4
    2062:	85be                	mv	a1,a5
    2064:	742a                	ld	s0,168(sp)
    2066:	748a                	ld	s1,160(sp)
    2068:	614d                	addi	sp,sp,176
    206a:	8082                	ret

000000000000206c <schedule_rm>:

/* Rate-Monotonic Scheduling */
struct threads_sched_result schedule_rm(struct threads_sched_args args)
{
    206c:	7171                	addi	sp,sp,-176
    206e:	f522                	sd	s0,168(sp)
    2070:	f126                	sd	s1,160(sp)
    2072:	1900                	addi	s0,sp,176
    2074:	84aa                	mv	s1,a0
    int is_miss = 0;
    2076:	fe042623          	sw	zero,-20(s0)
    struct thread *tws_period = NULL, *tws_id = NULL;
    207a:	fe043023          	sd	zero,-32(s0)
    207e:	fc043c23          	sd	zero,-40(s0)
    struct thread *th = NULL;
    2082:	fc043823          	sd	zero,-48(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    2086:	649c                	ld	a5,8(s1)
    2088:	639c                	ld	a5,0(a5)
    208a:	faf43423          	sd	a5,-88(s0)
    208e:	fa843783          	ld	a5,-88(s0)
    2092:	fd878793          	addi	a5,a5,-40
    2096:	fcf43823          	sd	a5,-48(s0)
    209a:	a895                	j	210e <schedule_rm+0xa2>
        if(args.current_time + th->remaining_time > th->current_deadline){
    209c:	4098                	lw	a4,0(s1)
    209e:	fd043783          	ld	a5,-48(s0)
    20a2:	47fc                	lw	a5,76(a5)
    20a4:	9fb9                	addw	a5,a5,a4
    20a6:	0007871b          	sext.w	a4,a5
    20aa:	fd043783          	ld	a5,-48(s0)
    20ae:	4bbc                	lw	a5,80(a5)
    20b0:	00e7d563          	bge	a5,a4,20ba <schedule_rm+0x4e>
            is_miss = 1;
    20b4:	4785                	li	a5,1
    20b6:	fef42623          	sw	a5,-20(s0)
            //break;
        }
        if (tws_period == NULL || (th->period < tws_period->period) || (th->period == tws_period->period && th->ID < tws_period->ID)) {
    20ba:	fe043783          	ld	a5,-32(s0)
    20be:	cb8d                	beqz	a5,20f0 <schedule_rm+0x84>
    20c0:	fd043783          	ld	a5,-48(s0)
    20c4:	43f8                	lw	a4,68(a5)
    20c6:	fe043783          	ld	a5,-32(s0)
    20ca:	43fc                	lw	a5,68(a5)
    20cc:	02f74263          	blt	a4,a5,20f0 <schedule_rm+0x84>
    20d0:	fd043783          	ld	a5,-48(s0)
    20d4:	43f8                	lw	a4,68(a5)
    20d6:	fe043783          	ld	a5,-32(s0)
    20da:	43fc                	lw	a5,68(a5)
    20dc:	00f71e63          	bne	a4,a5,20f8 <schedule_rm+0x8c>
    20e0:	fd043783          	ld	a5,-48(s0)
    20e4:	5398                	lw	a4,32(a5)
    20e6:	fe043783          	ld	a5,-32(s0)
    20ea:	539c                	lw	a5,32(a5)
    20ec:	00f75663          	bge	a4,a5,20f8 <schedule_rm+0x8c>
            tws_period = th;
    20f0:	fd043783          	ld	a5,-48(s0)
    20f4:	fef43023          	sd	a5,-32(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    20f8:	fd043783          	ld	a5,-48(s0)
    20fc:	779c                	ld	a5,40(a5)
    20fe:	f6f43823          	sd	a5,-144(s0)
    2102:	f7043783          	ld	a5,-144(s0)
    2106:	fd878793          	addi	a5,a5,-40
    210a:	fcf43823          	sd	a5,-48(s0)
    210e:	fd043783          	ld	a5,-48(s0)
    2112:	02878713          	addi	a4,a5,40
    2116:	649c                	ld	a5,8(s1)
    2118:	f8f712e3          	bne	a4,a5,209c <schedule_rm+0x30>
        }
    }

    struct threads_sched_result r; 
    if (tws_period != NULL) {
    211c:	fe043783          	ld	a5,-32(s0)
    2120:	16078063          	beqz	a5,2280 <schedule_rm+0x214>
        if(!is_miss){
    2124:	fec42783          	lw	a5,-20(s0)
    2128:	2781                	sext.w	a5,a5
    212a:	e3e9                	bnez	a5,21ec <schedule_rm+0x180>
            r.scheduled_thread_list_member = &tws_period->thread_list;
    212c:	fe043783          	ld	a5,-32(s0)
    2130:	02878793          	addi	a5,a5,40
    2134:	f4f43823          	sd	a5,-176(s0)
            struct release_queue_entry *rth;
            struct thread *find = NULL;
    2138:	fc043023          	sd	zero,-64(s0)
            list_for_each_entry(rth, args.release_queue, thread_list){
    213c:	689c                	ld	a5,16(s1)
    213e:	639c                	ld	a5,0(a5)
    2140:	f8f43023          	sd	a5,-128(s0)
    2144:	f8043783          	ld	a5,-128(s0)
    2148:	17e1                	addi	a5,a5,-8
    214a:	fcf43423          	sd	a5,-56(s0)
    214e:	a889                	j	21a0 <schedule_rm+0x134>
                if(find == NULL || rth->thrd->current_deadline + rth->thrd->period < find->current_deadline + find->period) {
    2150:	fc043783          	ld	a5,-64(s0)
    2154:	c79d                	beqz	a5,2182 <schedule_rm+0x116>
    2156:	fc843783          	ld	a5,-56(s0)
    215a:	639c                	ld	a5,0(a5)
    215c:	4bb8                	lw	a4,80(a5)
    215e:	fc843783          	ld	a5,-56(s0)
    2162:	639c                	ld	a5,0(a5)
    2164:	43fc                	lw	a5,68(a5)
    2166:	9fb9                	addw	a5,a5,a4
    2168:	0007859b          	sext.w	a1,a5
    216c:	fc043783          	ld	a5,-64(s0)
    2170:	4bb8                	lw	a4,80(a5)
    2172:	fc043783          	ld	a5,-64(s0)
    2176:	43fc                	lw	a5,68(a5)
    2178:	9fb9                	addw	a5,a5,a4
    217a:	2781                	sext.w	a5,a5
    217c:	872e                	mv	a4,a1
    217e:	00f75763          	bge	a4,a5,218c <schedule_rm+0x120>
                    find = rth->thrd;
    2182:	fc843783          	ld	a5,-56(s0)
    2186:	639c                	ld	a5,0(a5)
    2188:	fcf43023          	sd	a5,-64(s0)
            list_for_each_entry(rth, args.release_queue, thread_list){
    218c:	fc843783          	ld	a5,-56(s0)
    2190:	679c                	ld	a5,8(a5)
    2192:	f6f43c23          	sd	a5,-136(s0)
    2196:	f7843783          	ld	a5,-136(s0)
    219a:	17e1                	addi	a5,a5,-8
    219c:	fcf43423          	sd	a5,-56(s0)
    21a0:	fc843783          	ld	a5,-56(s0)
    21a4:	00878713          	addi	a4,a5,8
    21a8:	689c                	ld	a5,16(s1)
    21aa:	faf713e3          	bne	a4,a5,2150 <schedule_rm+0xe4>
                }
            }
    ...
    21b2:	cf89                	beqz	a5,21cc <schedule_rm+0x160>
    21b4:	4098                	lw	a4,0(s1)
    21b6:	fe043783          	ld	a5,-32(s0)
    21ba:	47fc                	lw	a5,76(a5)
    21bc:	9fb9                	addw	a5,a5,a4
    21be:	0007871b          	sext.w	a4,a5
    21c2:	fc043783          	ld	a5,-64(s0)
    21c6:	4bbc                	lw	a5,80(a5)
    21c8:	00e7c863          	blt	a5,a4,21d8 <schedule_rm+0x16c>
    21cc:	fe043783          	ld	a5,-32(s0)
    21d0:	47fc                	lw	a5,76(a5)
    21d2:	f4f42c23          	sw	a5,-168(s0)
    21d6:	aa39                	j	22f4 <schedule_rm+0x288>
            else{
                //r.allocated_time = tws_period->remaining_time;
                r.allocated_time = find->current_deadline - args.current_time;
    21d8:	fc043783          	ld	a5,-64(s0)
    21dc:	4bb8                	lw	a4,80(a5)
    21de:	409c                	lw	a5,0(s1)
    21e0:	40f707bb          	subw	a5,a4,a5
    21e4:	2781                	sext.w	a5,a5
    21e6:	f4f42c23          	sw	a5,-168(s0)
    21ea:	a229                	j	22f4 <schedule_rm+0x288>
            }
        }
        else{
            list_for_each_entry(th, args.run_queue, thread_list) {
    ...
    21f0:	f8f43823          	sd	a5,-112(s0)
    21f4:	f9043783          	ld	a5,-112(s0)
    21f8:	fd878793          	addi	a5,a5,-40
    21fc:	fcf43823          	sd	a5,-48(s0)
    2200:	a089                	j	2242 <schedule_rm+0x1d6>
                if (tws_id == NULL || (args.current_time >= th->current_deadline && th->ID < tws_id->ID)) {
    2202:	fd843783          	ld	a5,-40(s0)
    2206:	cf99                	beqz	a5,2224 <schedule_rm+0x1b8>
    2208:	4098                	lw	a4,0(s1)
    220a:	fd043783          	ld	a5,-48(s0)
    220e:	4bbc                	lw	a5,80(a5)
    2210:	00f74e63          	blt	a4,a5,222c <schedule_rm+0x1c0>
    2214:	fd043783          	ld	a5,-48(s0)
    2218:	5398                	lw	a4,32(a5)
    221a:	fd843783          	ld	a5,-40(s0)
    221e:	539c                	lw	a5,32(a5)
    2220:	00f75663          	bge	a4,a5,222c <schedule_rm+0x1c0>
                    tws_id = th;
    2224:	fd043783          	ld	a5,-48(s0)
    2228:	fcf43c23          	sd	a5,-40(s0)
            list_for_each_entry(th, args.run_queue, thread_list) {
    222c:	fd043783          	ld	a5,-48(s0)
    2230:	779c                	ld	a5,40(a5)
    2232:	f8f43423          	sd	a5,-120(s0)
    2236:	f8843783          	ld	a5,-120(s0)
    223a:	fd878793          	addi	a5,a5,-40
    223e:	fcf43823          	sd	a5,-48(s0)
    2242:	fd043783          	ld	a5,-48(s0)
    2246:	02878713          	addi	a4,a5,40
    224a:	649c                	ld	a5,8(s1)
    224c:	faf71be3          	bne	a4,a5,2202 <schedule_rm+0x196>
                }
            }
            r.scheduled_thread_list_member = &tws_id->thread_list;
    2250:	fd843783          	ld	a5,-40(s0)
    2254:	02878793          	addi	a5,a5,40
    2258:	f4f43823          	sd	a5,-176(s0)
            r.allocated_time = (tws_id->current_deadline - args.current_time < 0)? 0: tws_id->current_deadline - args.current_time;
    225c:	fd843783          	ld	a5,-40(s0)
    2260:	4bb8                	lw	a4,80(a5)
    2262:	409c                	lw	a5,0(s1)
    2264:	40f707bb          	subw	a5,a4,a5
    2268:	2781                	sext.w	a5,a5
    226a:	873e                	mv	a4,a5
    226c:	0007079b          	sext.w	a5,a4
    2270:	0007d363          	bgez	a5,2276 <schedule_rm+0x20a>
    2274:	4701                	li	a4,0
    2276:	0007079b          	sext.w	a5,a4
    227a:	f4f42c23          	sw	a5,-168(s0)
    227e:	a89d                	j	22f4 <schedule_rm+0x288>
        }
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    2280:	649c                	ld	a5,8(s1)
    2282:	f4f43823          	sd	a5,-176(s0)
            struct release_queue_entry *rth;
            struct thread *find = NULL;
    2286:	fa043823          	sd	zero,-80(s0)
            list_for_each_entry(rth, args.release_queue, thread_list) {
    228a:	689c                	ld	a5,16(s1)
    228c:	639c                	ld	a5,0(a5)
    228e:	faf43023          	sd	a5,-96(s0)
    2292:	fa043783          	ld	a5,-96(s0)
    2296:	17e1                	addi	a5,a5,-8
    2298:	faf43c23          	sd	a5,-72(s0)
    229c:	a825                	j	22d4 <schedule_rm+0x268>
            if (find == NULL || (rth->thrd->period < find->period)) {
    229e:	fb043783          	ld	a5,-80(s0)
    22a2:	cb91                	beqz	a5,22b6 <schedule_rm+0x24a>
    22a4:	fb843783          	ld	a5,-72(s0)
    22a8:	639c                	ld	a5,0(a5)
    22aa:	43f8                	lw	a4,68(a5)
    22ac:	fb043783          	ld	a5,-80(s0)
    22b0:	43fc                	lw	a5,68(a5)
    22b2:	00f75763          	bge	a4,a5,22c0 <schedule_rm+0x254>
                find = rth->thrd;
    22b6:	fb843783          	ld	a5,-72(s0)
    22ba:	639c                	ld	a5,0(a5)
    22bc:	faf43823          	sd	a5,-80(s0)
            list_for_each_entry(rth, args.release_queue, thread_list) {
    22c0:	fb843783          	ld	a5,-72(s0)
    22c4:	679c                	ld	a5,8(a5)
    22c6:	f8f43c23          	sd	a5,-104(s0)
    22ca:	f9843783          	ld	a5,-104(s0)
    22ce:	17e1                	addi	a5,a5,-8
    22d0:	faf43c23          	sd	a5,-72(s0)
    22d4:	fb843783          	ld	a5,-72(s0)
    22d8:	00878713          	addi	a4,a5,8
    22dc:	689c                	ld	a5,16(s1)
    22de:	fcf710e3          	bne	a4,a5,229e <schedule_rm+0x232>
            }
        }
        r.allocated_time = find->current_deadline - args.current_time;
    22e2:	fb043783          	ld	a5,-80(s0)
    22e6:	4bb8                	lw	a4,80(a5)
    22e8:	409c                	lw	a5,0(s1)
    22ea:	40f707bb          	subw	a5,a4,a5
    22ee:	2781                	sext.w	a5,a5
    22f0:	f4f42c23          	sw	a5,-168(s0)
    }

    return r;
    22f4:	f5043783          	ld	a5,-176(s0)
    22f8:	f6f43023          	sd	a5,-160(s0)
    22fc:	f5843783          	ld	a5,-168(s0)
    2300:	f6f43423          	sd	a5,-152(s0)
    2304:	f6043703          	ld	a4,-160(s0)
    2308:	f6843783          	ld	a5,-152(s0)
    230c:	863a                	mv	a2,a4
    230e:	86be                	mv	a3,a5
    2310:	8732                	mv	a4,a2
    2312:	87b6                	mv	a5,a3
    ...
    2314:	853a                	mv	a0,a4
    2316:	85be                	mv	a1,a5
    2318:	742a                	ld	s0,168(sp)
    231a:	748a                	ld	s1,160(sp)
    231c:	614d                	addi	sp,sp,176
    231e:	8082                	ret
