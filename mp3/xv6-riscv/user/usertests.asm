...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      54:	28050513          	addi	a0,a0,640 # 82d0 <schedule_rm+0x5d6>
    ...
    if(fd < 0){
      ...
      74:	26850513          	addi	a0,a0,616 # 82d8 <schedule_rm+0x5de>
    ...
    if(n >= 0){
      ...
      be:	23650513          	addi	a0,a0,566 # 82f0 <schedule_rm+0x5f6>
    ...
    unlink("copyin1");
      ...
      e6:	1ee50513          	addi	a0,a0,494 # 82d0 <schedule_rm+0x5d6>
    ...
    if(n > 0){
     ...
     122:	20250513          	addi	a0,a0,514 # 8320 <schedule_rm+0x626>
    ...
    if(pipe(fds) < 0){
     ...
     150:	20450513          	addi	a0,a0,516 # 8350 <schedule_rm+0x656>
    ...
    if(n > 0){
     ...
     19a:	1ca50513          	addi	a0,a0,458 # 8360 <schedule_rm+0x666>
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     22a:	16a50513          	addi	a0,a0,362 # 8390 <schedule_rm+0x696>
    ...
    if(fd < 0){
     ...
     24a:	15250513          	addi	a0,a0,338 # 8398 <schedule_rm+0x69e>
    ...
    if(n > 0){
     ...
     294:	12050513          	addi	a0,a0,288 # 83b0 <schedule_rm+0x6b6>
    ...
    if(pipe(fds) < 0){
     ...
     2d0:	08450513          	addi	a0,a0,132 # 8350 <schedule_rm+0x656>
    ...
    n = write(fds[1], "x", 1);
     ...
     2f0:	0f458593          	addi	a1,a1,244 # 83e0 <schedule_rm+0x6e6>
     2f4:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     316:	0d650513          	addi	a0,a0,214 # 83e8 <schedule_rm+0x6ee>
    ...
    if(n > 0){
     ...
     360:	0a450513          	addi	a0,a0,164 # 8400 <schedule_rm+0x706>
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     41a:	01a50513          	addi	a0,a0,26 # 8430 <schedule_rm+0x736>
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c8:	f8c50513          	addi	a0,a0,-116 # 8450 <schedule_rm+0x756>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     514:	f6050513          	addi	a0,a0,-160 # 8470 <schedule_rm+0x776>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     566:	f2e50513          	addi	a0,a0,-210 # 8490 <schedule_rm+0x796>
  ...
  char *args[] = { "xx", 0 };
     ...
     580:	f3c78793          	addi	a5,a5,-196 # 84b8 <schedule_rm+0x7be>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5c4:	f0050513          	addi	a0,a0,-256 # 84c0 <schedule_rm+0x7c6>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     ...
     5f6:	eee50513          	addi	a0,a0,-274 # 84e0 <schedule_rm+0x7e6>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     61e:	84e70713          	addi	a4,a4,-1970 # fe68 <big.0>
    ...
    ret = exec("echo", args2);
     ...
     682:	e7250513          	addi	a0,a0,-398 # 84f0 <schedule_rm+0x7f6>
    ...
    if(ret != -1){
     ...
     6ac:	e5050513          	addi	a0,a0,-432 # 84f8 <schedule_rm+0x7fe>
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     ...
     6f2:	e3250513          	addi	a0,a0,-462 # 8520 <schedule_rm+0x826>
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     ...
     788:	dec50513          	addi	a0,a0,-532 # 8570 <schedule_rm+0x876>
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7e2:	c7250513          	addi	a0,a0,-910 # 8450 <schedule_rm+0x756>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     82a:	c4a50513          	addi	a0,a0,-950 # 8470 <schedule_rm+0x776>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     876:	c1e50513          	addi	a0,a0,-994 # 8490 <schedule_rm+0x796>
  ...
  char *args[] = { "xx", 0 };
     ...
     890:	c2c78793          	addi	a5,a5,-980 # 84b8 <schedule_rm+0x7be>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8d0:	bf450513          	addi	a0,a0,-1036 # 84c0 <schedule_rm+0x7c6>
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     ...
     916:	c6650513          	addi	a0,a0,-922 # 8578 <schedule_rm+0x87e>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     ...
     942:	c5250513          	addi	a0,a0,-942 # 8590 <schedule_rm+0x896>
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     960:	6cc50513          	addi	a0,a0,1740 # 8028 <schedule_rm+0x32e>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     980:	c3450513          	addi	a0,a0,-972 # 85b0 <schedule_rm+0x8b6>
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d8:	bf450513          	addi	a0,a0,-1036 # 85c8 <schedule_rm+0x8ce>
  ...
  unlink("rwsbrk");
     ...
     a00:	62c50513          	addi	a0,a0,1580 # 8028 <schedule_rm+0x32e>
  ...
  fd = open("README", O_RDONLY);
     ...
     a12:	98250513          	addi	a0,a0,-1662 # 8390 <schedule_rm+0x696>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a32:	b8250513          	addi	a0,a0,-1150 # 85b0 <schedule_rm+0x8b6>
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a88:	b7450513          	addi	a0,a0,-1164 # 85f8 <schedule_rm+0x8fe>
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     af6:	b3e58593          	addi	a1,a1,-1218 # 8630 <schedule_rm+0x936>
     afa:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b18:	b0c50513          	addi	a0,a0,-1268 # 8620 <schedule_rm+0x926>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b64:	ad850513          	addi	a0,a0,-1320 # 8638 <schedule_rm+0x93e>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b82:	aa250513          	addi	a0,a0,-1374 # 8620 <schedule_rm+0x926>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b9a:	a8a50513          	addi	a0,a0,-1398 # 8620 <schedule_rm+0x926>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bdc:	a8050513          	addi	a0,a0,-1408 # 8658 <schedule_rm+0x95e>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     bf6:	a7650513          	addi	a0,a0,-1418 # 8668 <schedule_rm+0x96e>
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c3c:	a5050513          	addi	a0,a0,-1456 # 8688 <schedule_rm+0x98e>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     c56:	a1650513          	addi	a0,a0,-1514 # 8668 <schedule_rm+0x96e>
  ...
  write(fd1, "abcdef", 6);
     ...
     c76:	a2658593          	addi	a1,a1,-1498 # 8698 <schedule_rm+0x99e>
     c7a:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cbe:	9e650513          	addi	a0,a0,-1562 # 86a0 <schedule_rm+0x9a6>
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d0e:	9b650513          	addi	a0,a0,-1610 # 86c0 <schedule_rm+0x9c6>
  ...
  unlink("truncfile");
     ...
     d28:	8fc50513          	addi	a0,a0,-1796 # 8620 <schedule_rm+0x926>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d78:	8ac50513          	addi	a0,a0,-1876 # 8620 <schedule_rm+0x926>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d8c:	89850513          	addi	a0,a0,-1896 # 8620 <schedule_rm+0x926>
  ...
  write(fd1, "abcd", 4);
     ...
     da8:	88c58593          	addi	a1,a1,-1908 # 8630 <schedule_rm+0x936>
     dac:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     dbe:	86650513          	addi	a0,a0,-1946 # 8620 <schedule_rm+0x926>
  ...
  int n = write(fd1, "x", 1);
     ...
     dda:	60a58593          	addi	a1,a1,1546 # 83e0 <schedule_rm+0x6e6>
     dde:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e0a:	8da50513          	addi	a0,a0,-1830 # 86e0 <schedule_rm+0x9e6>
  ...
  unlink("truncfile");
     ...
     e24:	80050513          	addi	a0,a0,-2048 # 8620 <schedule_rm+0x926>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e6a:	7ba50513          	addi	a0,a0,1978 # 8620 <schedule_rm+0x926>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     ea2:	86a50513          	addi	a0,a0,-1942 # 8708 <schedule_rm+0xa0e>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ece:	75650513          	addi	a0,a0,1878 # 8620 <schedule_rm+0x926>
     ...
     ef2:	83250513          	addi	a0,a0,-1998 # 8720 <schedule_rm+0xa26>
     ...
     f12:	82a58593          	addi	a1,a1,-2006 # 8738 <schedule_rm+0xa3e>
     f16:	853e                	mv	a0,a5
     ...
     f42:	80a50513          	addi	a0,a0,-2038 # 8748 <schedule_rm+0xa4e>
     ...
     f6c:	6b850513          	addi	a0,a0,1720 # 8620 <schedule_rm+0x926>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fd6:	64e50513          	addi	a0,a0,1614 # 8620 <schedule_rm+0x926>
    ...
    if(fd < 0){
     ...
     ffa:	72a50513          	addi	a0,a0,1834 # 8720 <schedule_rm+0xa26>
    ...
    101a:	75258593          	addi	a1,a1,1874 # 8768 <schedule_rm+0xa6e>
    101e:	853e                	mv	a0,a5
    ...
    104a:	72a50513          	addi	a0,a0,1834 # 8770 <schedule_rm+0xa76>
  ...
  unlink("truncfile");
    ...
    109a:	58a50513          	addi	a0,a0,1418 # 8620 <schedule_rm+0x926>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10c4:	6d050513          	addi	a0,a0,1744 # 8790 <schedule_rm+0xa96>
    ...
    10de:	6be50513          	addi	a0,a0,1726 # 8798 <schedule_rm+0xa9e>
  ...
  if(chdir("iputdir") < 0){
    ...
    10f8:	69c50513          	addi	a0,a0,1692 # 8790 <schedule_rm+0xa96>
    ...
    1112:	6a250513          	addi	a0,a0,1698 # 87b0 <schedule_rm+0xab6>
  ...
  if(unlink("../iputdir") < 0){
    ...
    112c:	6a850513          	addi	a0,a0,1704 # 87d0 <schedule_rm+0xad6>
    ...
    1146:	69e50513          	addi	a0,a0,1694 # 87e0 <schedule_rm+0xae6>
  ...
  if(chdir("/") < 0){
    ...
    1160:	6a450513          	addi	a0,a0,1700 # 8800 <schedule_rm+0xb06>
    ...
    117a:	69250513          	addi	a0,a0,1682 # 8808 <schedule_rm+0xb0e>
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11c6:	54650513          	addi	a0,a0,1350 # 8708 <schedule_rm+0xa0e>
  ...
  if(pid == 0){
    ...
    11e8:	5ac50513          	addi	a0,a0,1452 # 8790 <schedule_rm+0xa96>
    ...
    1202:	59a50513          	addi	a0,a0,1434 # 8798 <schedule_rm+0xa9e>
    ...
    121c:	57850513          	addi	a0,a0,1400 # 8790 <schedule_rm+0xa96>
    ...
    1236:	5ee50513          	addi	a0,a0,1518 # 8820 <schedule_rm+0xb26>
    ...
    1250:	58450513          	addi	a0,a0,1412 # 87d0 <schedule_rm+0xad6>
    ...
    126a:	57a50513          	addi	a0,a0,1402 # 87e0 <schedule_rm+0xae6>
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12b6:	58650513          	addi	a0,a0,1414 # 8838 <schedule_rm+0xb3e>
    ...
    12d0:	57450513          	addi	a0,a0,1396 # 8840 <schedule_rm+0xb46>
  ...
  if(pid < 0){
    ...
    1306:	40650513          	addi	a0,a0,1030 # 8708 <schedule_rm+0xa0e>
  ...
  if(pid == 0){
    ...
    132a:	51250513          	addi	a0,a0,1298 # 8838 <schedule_rm+0xb3e>
    ...
    134e:	50e50513          	addi	a0,a0,1294 # 8858 <schedule_rm+0xb5e>
  ...
  if(unlink("oidir") != 0){
    ...
    137c:	4c050513          	addi	a0,a0,1216 # 8838 <schedule_rm+0xb3e>
    ...
    1394:	4f050513          	addi	a0,a0,1264 # 8880 <schedule_rm+0xb86>
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    ...
    13d8:	11c50513          	addi	a0,a0,284 # 84f0 <schedule_rm+0x7f6>
  ...
  if(fd < 0){
    ...
    13fc:	4a050513          	addi	a0,a0,1184 # 8898 <schedule_rm+0xb9e>
  ...
  fd = open("doesnotexist", 0);
    ...
    1426:	48e50513          	addi	a0,a0,1166 # 88b0 <schedule_rm+0xbb6>
  ...
  if(fd >= 0){
    ...
    144a:	47a50513          	addi	a0,a0,1146 # 88c0 <schedule_rm+0xbc6>
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    147e:	46e50513          	addi	a0,a0,1134 # 88e8 <schedule_rm+0xbee>
  ...
  if(fd < 0){
    ...
    14a2:	45250513          	addi	a0,a0,1106 # 88f0 <schedule_rm+0xbf6>
  ...
  for(i = 0; i < N; i++){
    ...
    14c8:	44c58593          	addi	a1,a1,1100 # 8910 <schedule_rm+0xc16>
    14cc:	853e                	mv	a0,a5
    ...
    14ee:	43650513          	addi	a0,a0,1078 # 8920 <schedule_rm+0xc26>
    ...
    150e:	43e58593          	addi	a1,a1,1086 # 8948 <schedule_rm+0xc4e>
    1512:	853e                	mv	a0,a5
    ...
    1534:	42850513          	addi	a0,a0,1064 # 8958 <schedule_rm+0xc5e>
  ...
  fd = open("small", O_RDONLY);
    ...
    1578:	37450513          	addi	a0,a0,884 # 88e8 <schedule_rm+0xbee>
  ...
  if(fd < 0){
    ...
    159c:	3e850513          	addi	a0,a0,1000 # 8980 <schedule_rm+0xc86>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15be:	19e58593          	addi	a1,a1,414 # a758 <buf>
    15c2:	853e                	mv	a0,a5
  ...
  if(i != N*SZ*2){
    ...
    15ea:	3ba50513          	addi	a0,a0,954 # 89a0 <schedule_rm+0xca6>
  ...
  if(unlink("small") < 0){
    ...
    1612:	2da50513          	addi	a0,a0,730 # 88e8 <schedule_rm+0xbee>
    ...
    162c:	39050513          	addi	a0,a0,912 # 89b8 <schedule_rm+0xcbe>
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1660:	37c50513          	addi	a0,a0,892 # 89d8 <schedule_rm+0xcde>
  ...
  if(fd < 0){
    ...
    1684:	36050513          	addi	a0,a0,864 # 89e0 <schedule_rm+0xce6>
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	0b878793          	addi	a5,a5,184 # a758 <buf>
    ...
    16ba:	0a258593          	addi	a1,a1,162 # a758 <buf>
    16be:	853e                	mv	a0,a5
    ...
    16e2:	32250513          	addi	a0,a0,802 # 8a00 <schedule_rm+0xd06>
  ...
  fd = open("big", O_RDONLY);
    ...
    1726:	2b650513          	addi	a0,a0,694 # 89d8 <schedule_rm+0xcde>
  ...
  if(fd < 0){
    ...
    174a:	2e250513          	addi	a0,a0,738 # 8a28 <schedule_rm+0xd2e>
  ...
  for(;;){
    ...
    1770:	fec58593          	addi	a1,a1,-20 # a758 <buf>
    1774:	853e                	mv	a0,a5
    ...
    17aa:	2a250513          	addi	a0,a0,674 # 8a48 <schedule_rm+0xd4e>
    ...
    17de:	29650513          	addi	a0,a0,662 # 8a70 <schedule_rm+0xd76>
    ...
    17f8:	f6478793          	addi	a5,a5,-156 # a758 <buf>
    ...
    180c:	f5078793          	addi	a5,a5,-176 # a758 <buf>
      printf("%s: read content of block %d is %d\n", s,
    ...
    1822:	26a50513          	addi	a0,a0,618 # 8a88 <schedule_rm+0xd8e>
  ...
  if(unlink("big") < 0){
    ...
    1858:	18450513          	addi	a0,a0,388 # 89d8 <schedule_rm+0xcde>
    ...
    1872:	24250513          	addi	a0,a0,578 # 8ab0 <schedule_rm+0xdb6>
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    196e:	15e50513          	addi	a0,a0,350 # 8ac8 <schedule_rm+0xdce>
    ...
    1988:	e1450513          	addi	a0,a0,-492 # 8798 <schedule_rm+0xa9e>
  ...
  if(chdir("dir0") < 0){
    ...
    19a2:	12a50513          	addi	a0,a0,298 # 8ac8 <schedule_rm+0xdce>
    ...
    19bc:	11850513          	addi	a0,a0,280 # 8ad0 <schedule_rm+0xdd6>
  ...
  if(chdir("..") < 0){
    ...
    19d6:	11650513          	addi	a0,a0,278 # 8ae8 <schedule_rm+0xdee>
    ...
    19f0:	10450513          	addi	a0,a0,260 # 8af0 <schedule_rm+0xdf6>
  ...
  if(unlink("dir0") < 0){
    ...
    1a0a:	0c250513          	addi	a0,a0,194 # 8ac8 <schedule_rm+0xdce>
    ...
    1a24:	0e850513          	addi	a0,a0,232 # 8b08 <schedule_rm+0xe0e>
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a54:	aa078793          	addi	a5,a5,-1376 # 84f0 <schedule_rm+0x7f6>
    1a58:	fcf43423          	sd	a5,-56(s0)
    1a5c:	00007797          	auipc	a5,0x7
    1a60:	0c478793          	addi	a5,a5,196 # 8b20 <schedule_rm+0xe26>
  ...
  unlink("echo-ok");
    ...
    1a70:	0bc50513          	addi	a0,a0,188 # 8b28 <schedule_rm+0xe2e>
  ...
  if(pid < 0) {
    ...
    1a9c:	c7050513          	addi	a0,a0,-912 # 8708 <schedule_rm+0xa0e>
  ...
  if(pid == 0) {
    ...
    1acc:	06050513          	addi	a0,a0,96 # 8b28 <schedule_rm+0xe2e>
    ...
    1af0:	04450513          	addi	a0,a0,68 # 8b30 <schedule_rm+0xe36>
    ...
    1b1c:	03050513          	addi	a0,a0,48 # 8b48 <schedule_rm+0xe4e>
    ...
    1b3c:	9b850513          	addi	a0,a0,-1608 # 84f0 <schedule_rm+0x7f6>
    ...
    1b56:	00650513          	addi	a0,a0,6 # 8b58 <schedule_rm+0xe5e>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b90:	fe450513          	addi	a0,a0,-28 # 8b70 <schedule_rm+0xe76>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1bb6:	f7650513          	addi	a0,a0,-138 # 8b28 <schedule_rm+0xe2e>
  ...
  if(fd < 0) {
    ...
    1bda:	b4a50513          	addi	a0,a0,-1206 # 8720 <schedule_rm+0xa26>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c18:	d8c50513          	addi	a0,a0,-628 # 89a0 <schedule_rm+0xca6>
  ...
  unlink("echo-ok");
    ...
    1c32:	efa50513          	addi	a0,a0,-262 # 8b28 <schedule_rm+0xe2e>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c6c:	f2050513          	addi	a0,a0,-224 # 8b88 <schedule_rm+0xe8e>
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1ca8:	efc50513          	addi	a0,a0,-260 # 8ba0 <schedule_rm+0xea6>
  ...
  if(pid == 0){
    ...
    1d06:	a5668693          	addi	a3,a3,-1450 # a758 <buf>
    ...
    1d3a:	a2258593          	addi	a1,a1,-1502 # a758 <buf>
    1d3e:	853e                	mv	a0,a5
    ...
    1d5c:	e6050513          	addi	a0,a0,-416 # 8bb8 <schedule_rm+0xebe>
    ...
    1dc2:	99a70713          	addi	a4,a4,-1638 # a758 <buf>
    ...
    1df4:	de050513          	addi	a0,a0,-544 # 8bd0 <schedule_rm+0xed6>
    ...
    1e56:	90658593          	addi	a1,a1,-1786 # a758 <buf>
    1e5a:	853e                	mv	a0,a5
    ...
    1e90:	d5c50513          	addi	a0,a0,-676 # 8be8 <schedule_rm+0xeee>
    ...
    1ed8:	d3450513          	addi	a0,a0,-716 # 8c08 <schedule_rm+0xf0e>
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1f22:	d0250513          	addi	a0,a0,-766 # 8c20 <schedule_rm+0xf26>
  ...
  if(pid2 < 0) {
    ...
    1f62:	7aa50513          	addi	a0,a0,1962 # 8708 <schedule_rm+0xa0e>
  ...
  if(pid3 < 0) {
    ...
    1fb0:	75c50513          	addi	a0,a0,1884 # 8708 <schedule_rm+0xa0e>
  ...
  if(pid3 == 0){
    ...
    1fe6:	3fe58593          	addi	a1,a1,1022 # 83e0 <schedule_rm+0x6e6>
    1fea:	853e                	mv	a0,a5
    ...
    2006:	c2e50513          	addi	a0,a0,-978 # 8c30 <schedule_rm+0xf36>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    203a:	72258593          	addi	a1,a1,1826 # a758 <buf>
    203e:	853e                	mv	a0,a5
    ...
    205a:	bf250513          	addi	a0,a0,-1038 # 8c48 <schedule_rm+0xf4e>
  ...
  printf("kill... ");
    ...
    207a:	bea50513          	addi	a0,a0,-1046 # 8c60 <schedule_rm+0xf66>
  ...
  printf("wait... ");
    ...
    20b4:	bc050513          	addi	a0,a0,-1088 # 8c70 <schedule_rm+0xf76>
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    2118:	5f450513          	addi	a0,a0,1524 # 8708 <schedule_rm+0xa0e>
    ...
    215a:	b2a50513          	addi	a0,a0,-1238 # 8c80 <schedule_rm+0xf86>
    ...
    2186:	b1650513          	addi	a0,a0,-1258 # 8c98 <schedule_rm+0xf9e>
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    2210:	4fc50513          	addi	a0,a0,1276 # 8708 <schedule_rm+0xa0e>
    ...
    224e:	a3650513          	addi	a0,a0,-1482 # 8c80 <schedule_rm+0xf86>
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    22f4:	41850513          	addi	a0,a0,1048 # 8708 <schedule_rm+0xa0e>
    ...
    233c:	3d050513          	addi	a0,a0,976 # 8708 <schedule_rm+0xa0e>
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    23d0:	85450513          	addi	a0,a0,-1964 # 8c20 <schedule_rm+0xf26>
  ...
  for(int i = 0; i < N; i++){
    ...
    2490:	82c50513          	addi	a0,a0,-2004 # 8cb8 <schedule_rm+0xfbe>
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    24da:	80250513          	addi	a0,a0,-2046 # 8cd8 <schedule_rm+0xfde>
  ...
  if(pid < 0){
    ...
    2506:	71e50513          	addi	a0,a0,1822 # 8c20 <schedule_rm+0xf26>
  ...
  if(pid == 0){
    ...
    252a:	7b250513          	addi	a0,a0,1970 # 8cd8 <schedule_rm+0xfde>
    ...
    2566:	77650513          	addi	a0,a0,1910 # 8cd8 <schedule_rm+0xfde>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    2592:	74a50513          	addi	a0,a0,1866 # 8cd8 <schedule_rm+0xfde>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    25f6:	eee50513          	addi	a0,a0,-274 # 84e0 <schedule_rm+0x7e6>
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    26f0:	5fc50513          	addi	a0,a0,1532 # 8ce8 <schedule_rm+0xfee>
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    2796:	57650513          	addi	a0,a0,1398 # 8d08 <schedule_rm+0x100e>
  ...
  for(i = 0; i < N; i++){
    ...
    280c:	52850513          	addi	a0,a0,1320 # 8d30 <schedule_rm+0x1036>
  ...
  fd = open("sharedfd", 0);
    ...
    2884:	8c850513          	addi	a0,a0,-1848 # 8148 <schedule_rm+0x44e>
  ...
  if(fd < 0){
    ...
    28a8:	4ac50513          	addi	a0,a0,1196 # 8d50 <schedule_rm+0x1056>
  ...
  unlink("sharedfd");
    ...
    2964:	7e850513          	addi	a0,a0,2024 # 8148 <schedule_rm+0x44e>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    29a6:	3d650513          	addi	a0,a0,982 # 8d78 <schedule_rm+0x107e>
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    29cc:	41878793          	addi	a5,a5,1048 # 8de0 <schedule_rm+0x10e6>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2a2e:	ab650513          	addi	a0,a0,-1354 # 84e0 <schedule_rm+0x7e6>
    ...
    2a74:	32050513          	addi	a0,a0,800 # 8d90 <schedule_rm+0x1096>
    ...
    2a9e:	cbe50513          	addi	a0,a0,-834 # a758 <buf>
    ...
    2abc:	ca058593          	addi	a1,a1,-864 # a758 <buf>
    2ac0:	853e                	mv	a0,a5
    ...
    2aea:	2ba50513          	addi	a0,a0,698 # 8da0 <schedule_rm+0x10a6>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2bb8:	ba470713          	addi	a4,a4,-1116 # a758 <buf>
    ...
    2be0:	1dc50513          	addi	a0,a0,476 # 8db8 <schedule_rm+0x10be>
    ...
    2c28:	b3458593          	addi	a1,a1,-1228 # a758 <buf>
    2c2c:	853e                	mv	a0,a5
    ...
    2c70:	15c50513          	addi	a0,a0,348 # 8dc8 <schedule_rm+0x10ce>
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2ce8:	7fc50513          	addi	a0,a0,2044 # 84e0 <schedule_rm+0x7e6>
    ...
    2d64:	dd050513          	addi	a0,a0,-560 # 8b30 <schedule_rm+0xe36>
    ...
    2dd8:	aac50513          	addi	a0,a0,-1364 # 8880 <schedule_rm+0xb86>
  ...
  for(i = 0; i < N; i++){
    ...
    2ef0:	f1450513          	addi	a0,a0,-236 # 8e00 <schedule_rm+0x1106>
    ...
    2f36:	ef650513          	addi	a0,a0,-266 # 8e28 <schedule_rm+0x112e>
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3026:	0ee50513          	addi	a0,a0,238 # 8110 <schedule_rm+0x416>
  ...
  if(fd < 0){
    ...
    304a:	e0a50513          	addi	a0,a0,-502 # 8e50 <schedule_rm+0x1156>
  ...
  write(fd, "hello", SZ);
    ...
    306a:	e0a58593          	addi	a1,a1,-502 # 8e70 <schedule_rm+0x1176>
    306e:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    308c:	08850513          	addi	a0,a0,136 # 8110 <schedule_rm+0x416>
  ...
  if(fd < 0){
    ...
    30b0:	dcc50513          	addi	a0,a0,-564 # 8e78 <schedule_rm+0x117e>
  ...
  if(unlink("unlinkread") != 0){
    ...
    30ca:	04a50513          	addi	a0,a0,74 # 8110 <schedule_rm+0x416>
    ...
    30e2:	dba50513          	addi	a0,a0,-582 # 8e98 <schedule_rm+0x119e>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3100:	01450513          	addi	a0,a0,20 # 8110 <schedule_rm+0x416>
  ...
  write(fd1, "yyy", 3);
    ...
    311c:	da058593          	addi	a1,a1,-608 # 8eb8 <schedule_rm+0x11be>
    3120:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3142:	61a58593          	addi	a1,a1,1562 # a758 <buf>
    3146:	853e                	mv	a0,a5
    ...
    3162:	d6250513          	addi	a0,a0,-670 # 8ec0 <schedule_rm+0x11c6>
  ...
  if(buf[0] != 'h'){
    ...
    317c:	5e078793          	addi	a5,a5,1504 # a758 <buf>
    ...
    3196:	d4e50513          	addi	a0,a0,-690 # 8ee0 <schedule_rm+0x11e6>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    31b6:	5a658593          	addi	a1,a1,1446 # a758 <buf>
    31ba:	853e                	mv	a0,a5
    ...
    31d6:	d2e50513          	addi	a0,a0,-722 # 8f00 <schedule_rm+0x1206>
  ...
  unlink("unlinkread");
    ...
    31fe:	f1650513          	addi	a0,a0,-234 # 8110 <schedule_rm+0x416>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    ...
    3224:	d0050513          	addi	a0,a0,-768 # 8f20 <schedule_rm+0x1226>
    3228:	00004097          	auipc	ra,0x4
    322c:	ea2080e7          	jalr	-350(ra) # 70ca <unlink>
  unlink("lf2");
    3230:	00006517          	auipc	a0,0x6
    3234:	cf850513          	addi	a0,a0,-776 # 8f28 <schedule_rm+0x122e>
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    3248:	cdc50513          	addi	a0,a0,-804 # 8f20 <schedule_rm+0x1226>
  ...
  if(fd < 0){
    ...
    326c:	cc850513          	addi	a0,a0,-824 # 8f30 <schedule_rm+0x1236>
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    328c:	be858593          	addi	a1,a1,-1048 # 8e70 <schedule_rm+0x1176>
    3290:	853e                	mv	a0,a5
    ...
    32ac:	ca050513          	addi	a0,a0,-864 # 8f48 <schedule_rm+0x124e>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    32d4:	c5858593          	addi	a1,a1,-936 # 8f28 <schedule_rm+0x122e>
    32d8:	00006517          	auipc	a0,0x6
    32dc:	c4850513          	addi	a0,a0,-952 # 8f20 <schedule_rm+0x1226>
    ...
    32f6:	c6e50513          	addi	a0,a0,-914 # 8f60 <schedule_rm+0x1266>
  ...
  unlink("lf1");
    ...
    3310:	c1450513          	addi	a0,a0,-1004 # 8f20 <schedule_rm+0x1226>
  ...
  if(open("lf1", 0) >= 0){
    ...
    3322:	c0250513          	addi	a0,a0,-1022 # 8f20 <schedule_rm+0x1226>
    ...
    333c:	c4850513          	addi	a0,a0,-952 # 8f80 <schedule_rm+0x1286>
  ...
  fd = open("lf2", 0);
    ...
    3358:	bd450513          	addi	a0,a0,-1068 # 8f28 <schedule_rm+0x122e>
  ...
  if(fd < 0){
    ...
    337c:	c3850513          	addi	a0,a0,-968 # 8fb0 <schedule_rm+0x12b6>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    339c:	3c058593          	addi	a1,a1,960 # a758 <buf>
    33a0:	853e                	mv	a0,a5
    ...
    33bc:	c1050513          	addi	a0,a0,-1008 # 8fc8 <schedule_rm+0x12ce>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    33e4:	b4858593          	addi	a1,a1,-1208 # 8f28 <schedule_rm+0x122e>
    33e8:	00006517          	auipc	a0,0x6
    33ec:	b4050513          	addi	a0,a0,-1216 # 8f28 <schedule_rm+0x122e>
    ...
    3406:	bde50513          	addi	a0,a0,-1058 # 8fe0 <schedule_rm+0x12e6>
  ...
  unlink("lf2");
    ...
    3420:	b0c50513          	addi	a0,a0,-1268 # 8f28 <schedule_rm+0x122e>
    3424:	00004097          	auipc	ra,0x4
    3428:	ca6080e7          	jalr	-858(ra) # 70ca <unlink>
  if(link("lf2", "lf1") >= 0){
    342c:	00006597          	auipc	a1,0x6
    3430:	af458593          	addi	a1,a1,-1292 # 8f20 <schedule_rm+0x1226>
    3434:	00006517          	auipc	a0,0x6
    3438:	af450513          	addi	a0,a0,-1292 # 8f28 <schedule_rm+0x122e>
    ...
    3452:	bba50513          	addi	a0,a0,-1094 # 9008 <schedule_rm+0x130e>
  ...
  if(link(".", "lf1") >= 0){
    ...
    346c:	ab858593          	addi	a1,a1,-1352 # 8f20 <schedule_rm+0x1226>
    3470:	00006517          	auipc	a0,0x6
    3474:	bc050513          	addi	a0,a0,-1088 # 9030 <schedule_rm+0x1336>
    ...
    348e:	bae50513          	addi	a0,a0,-1106 # 9038 <schedule_rm+0x133e>
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    3522:	b3a50513          	addi	a0,a0,-1222 # 9058 <schedule_rm+0x135e>
    ...
    3556:	b0650513          	addi	a0,a0,-1274 # 9058 <schedule_rm+0x135e>
    ...
    3590:	ad450513          	addi	a0,a0,-1324 # 9060 <schedule_rm+0x1366>
  ...
  fd = open(".", 0);
    ...
    3618:	a1c50513          	addi	a0,a0,-1508 # 9030 <schedule_rm+0x1336>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3682:	a0250513          	addi	a0,a0,-1534 # 9080 <schedule_rm+0x1386>
    ...
    36b8:	9ec50513          	addi	a0,a0,-1556 # 90a0 <schedule_rm+0x13a6>
  ...
  if(n != N){
    ...
    372a:	9a250513          	addi	a0,a0,-1630 # 90c8 <schedule_rm+0x13ce>
  ...
  for(i = 0; i < N; i++){
    ...
    377a:	f9250513          	addi	a0,a0,-110 # 8708 <schedule_rm+0xa0e>
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    3912:	ad250513          	addi	a0,a0,-1326 # 83e0 <schedule_rm+0x6e6>
  ...
  if(pid < 0){
    ...
    393e:	dce50513          	addi	a0,a0,-562 # 8708 <schedule_rm+0xa0e>
  ...
  for(i = 0; i < 100; i++){
    ...
    39a4:	a4050513          	addi	a0,a0,-1472 # 83e0 <schedule_rm+0x6e6>
    ...
    39d6:	a0e58593          	addi	a1,a1,-1522 # 83e0 <schedule_rm+0x6e6>
    39da:	00005517          	auipc	a0,0x5
    39de:	72650513          	addi	a0,a0,1830 # 9100 <schedule_rm+0x1406>
    ...
    39f0:	9f450513          	addi	a0,a0,-1548 # 83e0 <schedule_rm+0x6e6>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    3a4c:	6c050513          	addi	a0,a0,1728 # 9108 <schedule_rm+0x140e>
  ...
  fd = open("bd", O_CREATE);
    ...
    3a60:	6ac50513          	addi	a0,a0,1708 # 9108 <schedule_rm+0x140e>
  ...
  if(fd < 0){
    ...
    3a84:	69050513          	addi	a0,a0,1680 # 9110 <schedule_rm+0x1416>
  ...
  for(i = 0; i < N; i++){
    ...
    3b10:	5fc50513          	addi	a0,a0,1532 # 9108 <schedule_rm+0x140e>
    ...
    3b2e:	60650513          	addi	a0,a0,1542 # 9130 <schedule_rm+0x1436>
  ...
  unlink("bd");
    ...
    3b62:	5aa50513          	addi	a0,a0,1450 # 9108 <schedule_rm+0x140e>
  ...
  for(i = 0; i < N; i++){
    ...
    3be6:	56e50513          	addi	a0,a0,1390 # 9150 <schedule_rm+0x1456>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3c32:	54250513          	addi	a0,a0,1346 # 9170 <schedule_rm+0x1476>
    3c36:	00003097          	auipc	ra,0x3
    3c3a:	494080e7          	jalr	1172(ra) # 70ca <unlink>
  if(mkdir("dd") != 0){
    3c3e:	00005517          	auipc	a0,0x5
    3c42:	53a50513          	addi	a0,a0,1338 # 9178 <schedule_rm+0x147e>
    ...
    3c5a:	52a50513          	addi	a0,a0,1322 # 9180 <schedule_rm+0x1486>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3c78:	52450513          	addi	a0,a0,1316 # 9198 <schedule_rm+0x149e>
  ...
  if(fd < 0){
    ...
    3c9c:	50850513          	addi	a0,a0,1288 # 91a0 <schedule_rm+0x14a6>
  ...
  write(fd, "ff", 2);
    ...
    3cbc:	4b858593          	addi	a1,a1,1208 # 9170 <schedule_rm+0x1476>
    3cc0:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3cdc:	4a050513          	addi	a0,a0,1184 # 9178 <schedule_rm+0x147e>
    ...
    3cf6:	4ce50513          	addi	a0,a0,1230 # 91c0 <schedule_rm+0x14c6>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3d10:	4e450513          	addi	a0,a0,1252 # 91f0 <schedule_rm+0x14f6>
    ...
    3d28:	4d450513          	addi	a0,a0,1236 # 91f8 <schedule_rm+0x14fe>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3d46:	4d650513          	addi	a0,a0,1238 # 9218 <schedule_rm+0x151e>
  ...
  if(fd < 0){
    ...
    3d6a:	4c250513          	addi	a0,a0,1218 # 9228 <schedule_rm+0x152e>
  ...
  write(fd, "FF", 2);
    ...
    3d8a:	4c258593          	addi	a1,a1,1218 # 9248 <schedule_rm+0x154e>
    3d8e:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3dac:	4a850513          	addi	a0,a0,1192 # 9250 <schedule_rm+0x1556>
  ...
  if(fd < 0){
    ...
    3dd0:	49450513          	addi	a0,a0,1172 # 9260 <schedule_rm+0x1566>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3df0:	96c58593          	addi	a1,a1,-1684 # a758 <buf>
    3df4:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3e16:	94678793          	addi	a5,a5,-1722 # a758 <buf>
    ...
    3e30:	45450513          	addi	a0,a0,1108 # 9280 <schedule_rm+0x1586>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3e58:	44c58593          	addi	a1,a1,1100 # 92a0 <schedule_rm+0x15a6>
    3e5c:	00005517          	auipc	a0,0x5
    3e60:	3bc50513          	addi	a0,a0,956 # 9218 <schedule_rm+0x151e>
    ...
    3e78:	43c50513          	addi	a0,a0,1084 # 92b0 <schedule_rm+0x15b6>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3e92:	38a50513          	addi	a0,a0,906 # 9218 <schedule_rm+0x151e>
    ...
    3eaa:	43250513          	addi	a0,a0,1074 # 92d8 <schedule_rm+0x15de>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3ec6:	35650513          	addi	a0,a0,854 # 9218 <schedule_rm+0x151e>
    ...
    3ee0:	41c50513          	addi	a0,a0,1052 # 92f8 <schedule_rm+0x15fe>
  ...
  if(chdir("dd") != 0){
    ...
    3efa:	28250513          	addi	a0,a0,642 # 9178 <schedule_rm+0x147e>
    ...
    3f12:	41250513          	addi	a0,a0,1042 # 9320 <schedule_rm+0x1626>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3f2c:	41050513          	addi	a0,a0,1040 # 9338 <schedule_rm+0x163e>
    ...
    3f44:	40850513          	addi	a0,a0,1032 # 9348 <schedule_rm+0x164e>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3f5e:	40e50513          	addi	a0,a0,1038 # 9368 <schedule_rm+0x166e>
    ...
    3f76:	40650513          	addi	a0,a0,1030 # 9378 <schedule_rm+0x167e>
  ...
  if(chdir("./..") != 0){
    ...
    3f90:	40c50513          	addi	a0,a0,1036 # 9398 <schedule_rm+0x169e>
    ...
    3fa8:	3fc50513          	addi	a0,a0,1020 # 93a0 <schedule_rm+0x16a6>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3fc4:	2e050513          	addi	a0,a0,736 # 92a0 <schedule_rm+0x15a6>
  ...
  if(fd < 0){
    ...
    3fe8:	3d450513          	addi	a0,a0,980 # 93b8 <schedule_rm+0x16be>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    4008:	75458593          	addi	a1,a1,1876 # a758 <buf>
    400c:	853e                	mv	a0,a5
    ...
    4028:	3b450513          	addi	a0,a0,948 # 93d8 <schedule_rm+0x16de>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    4052:	1ca50513          	addi	a0,a0,458 # 9218 <schedule_rm+0x151e>
    ...
    406c:	39050513          	addi	a0,a0,912 # 93f8 <schedule_rm+0x16fe>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    408a:	3a250513          	addi	a0,a0,930 # 9428 <schedule_rm+0x172e>
    ...
    40a4:	39850513          	addi	a0,a0,920 # 9438 <schedule_rm+0x173e>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    40c2:	39a50513          	addi	a0,a0,922 # 9458 <schedule_rm+0x175e>
    ...
    40dc:	39050513          	addi	a0,a0,912 # 9468 <schedule_rm+0x176e>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    40fa:	08250513          	addi	a0,a0,130 # 9178 <schedule_rm+0x147e>
    ...
    4114:	37850513          	addi	a0,a0,888 # 9488 <schedule_rm+0x178e>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    4130:	04c50513          	addi	a0,a0,76 # 9178 <schedule_rm+0x147e>
    ...
    414a:	36250513          	addi	a0,a0,866 # 94a8 <schedule_rm+0x17ae>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    4166:	01650513          	addi	a0,a0,22 # 9178 <schedule_rm+0x147e>
    ...
    4180:	34c50513          	addi	a0,a0,844 # 94c8 <schedule_rm+0x17ce>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    419a:	35258593          	addi	a1,a1,850 # 94e8 <schedule_rm+0x17ee>
    419e:	00005517          	auipc	a0,0x5
    41a2:	28a50513          	addi	a0,a0,650 # 9428 <schedule_rm+0x172e>
    ...
    41ba:	34250513          	addi	a0,a0,834 # 94f8 <schedule_rm+0x17fe>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    41d4:	31858593          	addi	a1,a1,792 # 94e8 <schedule_rm+0x17ee>
    41d8:	00005517          	auipc	a0,0x5
    41dc:	28050513          	addi	a0,a0,640 # 9458 <schedule_rm+0x175e>
    ...
    41f4:	33050513          	addi	a0,a0,816 # 9520 <schedule_rm+0x1826>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    420e:	09658593          	addi	a1,a1,150 # 92a0 <schedule_rm+0x15a6>
    4212:	00005517          	auipc	a0,0x5
    4216:	f8650513          	addi	a0,a0,-122 # 9198 <schedule_rm+0x149e>
    ...
    422e:	31e50513          	addi	a0,a0,798 # 9548 <schedule_rm+0x184e>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    4248:	1e450513          	addi	a0,a0,484 # 9428 <schedule_rm+0x172e>
    ...
    4260:	31450513          	addi	a0,a0,788 # 9570 <schedule_rm+0x1876>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    427a:	1e250513          	addi	a0,a0,482 # 9458 <schedule_rm+0x175e>
    ...
    4292:	30250513          	addi	a0,a0,770 # 9590 <schedule_rm+0x1896>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    42ac:	ff850513          	addi	a0,a0,-8 # 92a0 <schedule_rm+0x15a6>
    ...
    42c4:	2f050513          	addi	a0,a0,752 # 95b0 <schedule_rm+0x18b6>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    42de:	17e50513          	addi	a0,a0,382 # 9458 <schedule_rm+0x175e>
    ...
    42f6:	2e650513          	addi	a0,a0,742 # 95d8 <schedule_rm+0x18de>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    4310:	11c50513          	addi	a0,a0,284 # 9428 <schedule_rm+0x172e>
    ...
    4328:	2d450513          	addi	a0,a0,724 # 95f8 <schedule_rm+0x18fe>
  ...
  if(chdir("dd/ff") == 0){
    ...
    4342:	e5a50513          	addi	a0,a0,-422 # 9198 <schedule_rm+0x149e>
    ...
    435a:	2c250513          	addi	a0,a0,706 # 9618 <schedule_rm+0x191e>
  ...
  if(chdir("dd/xx") == 0){
    ...
    4374:	2c850513          	addi	a0,a0,712 # 9638 <schedule_rm+0x193e>
    ...
    438c:	2b850513          	addi	a0,a0,696 # 9640 <schedule_rm+0x1946>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    43a6:	efe50513          	addi	a0,a0,-258 # 92a0 <schedule_rm+0x15a6>
    ...
    43be:	f1e50513          	addi	a0,a0,-226 # 92d8 <schedule_rm+0x15de>
  ...
  if(unlink("dd/ff") != 0){
    ...
    43d8:	dc450513          	addi	a0,a0,-572 # 9198 <schedule_rm+0x149e>
    ...
    43f0:	27450513          	addi	a0,a0,628 # 9660 <schedule_rm+0x1966>
  ...
  if(unlink("dd") == 0){
    ...
    440a:	d7250513          	addi	a0,a0,-654 # 9178 <schedule_rm+0x147e>
    ...
    4422:	26250513          	addi	a0,a0,610 # 9680 <schedule_rm+0x1986>
  ...
  if(unlink("dd/dd") < 0){
    ...
    443c:	27050513          	addi	a0,a0,624 # 96a8 <schedule_rm+0x19ae>
    ...
    4456:	25e50513          	addi	a0,a0,606 # 96b0 <schedule_rm+0x19b6>
  ...
  if(unlink("dd") < 0){
    ...
    4470:	d0c50513          	addi	a0,a0,-756 # 9178 <schedule_rm+0x147e>
    ...
    448a:	24a50513          	addi	a0,a0,586 # 96d0 <schedule_rm+0x19d6>
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    ...
    44ba:	cca50513          	addi	a0,a0,-822 # 8180 <schedule_rm+0x486>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    44d8:	cac50513          	addi	a0,a0,-852 # 8180 <schedule_rm+0x486>
    ...
    44fc:	1f050513          	addi	a0,a0,496 # 96e8 <schedule_rm+0x19ee>
    ...
    4526:	23658593          	addi	a1,a1,566 # a758 <buf>
    452a:	853e                	mv	a0,a5
    ...
    455e:	1ae50513          	addi	a0,a0,430 # 9708 <schedule_rm+0x1a0e>
    ...
    459e:	be650513          	addi	a0,a0,-1050 # 8180 <schedule_rm+0x486>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    460a:	eda50513          	addi	a0,a0,-294 # 84e0 <schedule_rm+0x7e6>
    ...
    4694:	09050513          	addi	a0,a0,144 # 9720 <schedule_rm+0x1a26>
    ...
    46be:	09e58593          	addi	a1,a1,158 # a758 <buf>
    46c2:	853e                	mv	a0,a5
    ...
    46f6:	01650513          	addi	a0,a0,22 # 9708 <schedule_rm+0x1a0e>
...
bigfile(char *s)
{
  ...
  if(fd < 0){
    ...
    4826:	f2650513          	addi	a0,a0,-218 # 9748 <schedule_rm+0x1a4e>
  ...
  for(i = 0; i < N; i++){
    ...
    4850:	f0c50513          	addi	a0,a0,-244 # a758 <buf>
    ...
    4868:	ef458593          	addi	a1,a1,-268 # a758 <buf>
    486c:	853e                	mv	a0,a5
    ...
    488a:	ee250513          	addi	a0,a0,-286 # 9768 <schedule_rm+0x1a6e>
  ...
  fd = open("bigfile.dat", 0);
    ...
    48cc:	e7050513          	addi	a0,a0,-400 # 9738 <schedule_rm+0x1a3e>
  ...
  if(fd < 0){
    ...
    48f0:	e9c50513          	addi	a0,a0,-356 # 9788 <schedule_rm+0x1a8e>
  ...
  for(i = 0; ; i++){
    ...
    491a:	e4258593          	addi	a1,a1,-446 # a758 <buf>
    491e:	853e                	mv	a0,a5
    ...
    4940:	e6c50513          	addi	a0,a0,-404 # 97a8 <schedule_rm+0x1aae>
    ...
    4976:	e5650513          	addi	a0,a0,-426 # 97c8 <schedule_rm+0x1ace>
    ...
    4990:	dcc78793          	addi	a5,a5,-564 # a758 <buf>
    ...
    49b6:	da678793          	addi	a5,a5,-602 # a758 <buf>
    ...
    49e0:	e0450513          	addi	a0,a0,-508 # 97e0 <schedule_rm+0x1ae6>
  ...
  if(total != N*SZ){
    ...
    4a3a:	dca50513          	addi	a0,a0,-566 # 9800 <schedule_rm+0x1b06>
  ...
  unlink("bigfile.dat");
    ...
    4a54:	ce850513          	addi	a0,a0,-792 # 9738 <schedule_rm+0x1a3e>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    4a7a:	daa50513          	addi	a0,a0,-598 # 9820 <schedule_rm+0x1b26>
    ...
    4a92:	da250513          	addi	a0,a0,-606 # 9830 <schedule_rm+0x1b36>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    4aac:	db050513          	addi	a0,a0,-592 # 9858 <schedule_rm+0x1b5e>
    ...
    4ac4:	db850513          	addi	a0,a0,-584 # 9878 <schedule_rm+0x1b7e>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    4ae2:	dd250513          	addi	a0,a0,-558 # 98b0 <schedule_rm+0x1bb6>
  ...
  if(fd < 0){
    ...
    4b06:	dde50513          	addi	a0,a0,-546 # 98e0 <schedule_rm+0x1be6>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    4b30:	dfc50513          	addi	a0,a0,-516 # 9928 <schedule_rm+0x1c2e>
  ...
  if(fd < 0){
    ...
    4b54:	e0850513          	addi	a0,a0,-504 # 9958 <schedule_rm+0x1c5e>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    4b7c:	e2050513          	addi	a0,a0,-480 # 9998 <schedule_rm+0x1c9e>
    ...
    4b94:	e2850513          	addi	a0,a0,-472 # 99b8 <schedule_rm+0x1cbe>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    4bae:	e4650513          	addi	a0,a0,-442 # 99f0 <schedule_rm+0x1cf6>
    ...
    4bc6:	e4e50513          	addi	a0,a0,-434 # 9a10 <schedule_rm+0x1d16>
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    ...
    4c56:	df650513          	addi	a0,a0,-522 # 9a48 <schedule_rm+0x1d4e>
    ...
    4c6e:	de650513          	addi	a0,a0,-538 # 9a50 <schedule_rm+0x1d56>
  ...
  if(chdir("dots") != 0){
    ...
    4c88:	dc450513          	addi	a0,a0,-572 # 9a48 <schedule_rm+0x1d4e>
    ...
    4ca0:	dcc50513          	addi	a0,a0,-564 # 9a68 <schedule_rm+0x1d6e>
  ...
  if(unlink(".") == 0){
    ...
    4cba:	37a50513          	addi	a0,a0,890 # 9030 <schedule_rm+0x1336>
    ...
    4cd2:	db250513          	addi	a0,a0,-590 # 9a80 <schedule_rm+0x1d86>
  ...
  if(unlink("..") == 0){
    ...
    4cec:	e0050513          	addi	a0,a0,-512 # 8ae8 <schedule_rm+0xdee>
    ...
    4d04:	d9850513          	addi	a0,a0,-616 # 9a98 <schedule_rm+0x1d9e>
  ...
  if(chdir("/") != 0){
    ...
    4d1e:	ae650513          	addi	a0,a0,-1306 # 8800 <schedule_rm+0xb06>
    ...
    4d36:	ad650513          	addi	a0,a0,-1322 # 8808 <schedule_rm+0xb0e>
  ...
  if(unlink("dots/.") == 0){
    ...
    4d50:	d6450513          	addi	a0,a0,-668 # 9ab0 <schedule_rm+0x1db6>
    ...
    4d68:	d5450513          	addi	a0,a0,-684 # 9ab8 <schedule_rm+0x1dbe>
  ...
  if(unlink("dots/..") == 0){
    ...
    4d82:	d5a50513          	addi	a0,a0,-678 # 9ad8 <schedule_rm+0x1dde>
    ...
    4d9a:	d4a50513          	addi	a0,a0,-694 # 9ae0 <schedule_rm+0x1de6>
  ...
  if(unlink("dots") != 0){
    ...
    4db4:	c9850513          	addi	a0,a0,-872 # 9a48 <schedule_rm+0x1d4e>
    ...
    4dcc:	d3850513          	addi	a0,a0,-712 # 9b00 <schedule_rm+0x1e06>
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4e00:	4ac50513          	addi	a0,a0,1196 # 82a8 <schedule_rm+0x5ae>
  ...
  if(fd < 0){
    ...
    4e24:	d0050513          	addi	a0,a0,-768 # 9b20 <schedule_rm+0x1e26>
  ...
  if(chdir("dirfile") == 0){
    ...
    4e4c:	46050513          	addi	a0,a0,1120 # 82a8 <schedule_rm+0x5ae>
    ...
    4e64:	ce050513          	addi	a0,a0,-800 # 9b40 <schedule_rm+0x1e46>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4e80:	ce450513          	addi	a0,a0,-796 # 9b60 <schedule_rm+0x1e66>
  ...
  if(fd >= 0){
    ...
    4ea4:	cd050513          	addi	a0,a0,-816 # 9b70 <schedule_rm+0x1e76>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4ec2:	ca250513          	addi	a0,a0,-862 # 9b60 <schedule_rm+0x1e66>
  ...
  if(fd >= 0){
    ...
    4ee6:	c8e50513          	addi	a0,a0,-882 # 9b70 <schedule_rm+0x1e76>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4f00:	c6450513          	addi	a0,a0,-924 # 9b60 <schedule_rm+0x1e66>
    ...
    4f18:	c8450513          	addi	a0,a0,-892 # 9b98 <schedule_rm+0x1e9e>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4f32:	c3250513          	addi	a0,a0,-974 # 9b60 <schedule_rm+0x1e66>
    ...
    4f4a:	c7a50513          	addi	a0,a0,-902 # 9bc0 <schedule_rm+0x1ec6>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4f64:	c0058593          	addi	a1,a1,-1024 # 9b60 <schedule_rm+0x1e66>
    4f68:	00003517          	auipc	a0,0x3
    4f6c:	42850513          	addi	a0,a0,1064 # 8390 <schedule_rm+0x696>
    ...
    4f84:	c6850513          	addi	a0,a0,-920 # 9be8 <schedule_rm+0x1eee>
  ...
  if(unlink("dirfile") != 0){
    ...
    4f9e:	30e50513          	addi	a0,a0,782 # 82a8 <schedule_rm+0x5ae>
    ...
    4fb6:	c5e50513          	addi	a0,a0,-930 # 9c10 <schedule_rm+0x1f16>
  ...
  fd = open(".", O_RDWR);
    ...
    4fd2:	06250513          	addi	a0,a0,98 # 9030 <schedule_rm+0x1336>
  ...
  if(fd >= 0){
    ...
    4ff6:	c3e50513          	addi	a0,a0,-962 # 9c30 <schedule_rm+0x1f36>
  ...
  fd = open(".", 0);
    ...
    5012:	02250513          	addi	a0,a0,34 # 9030 <schedule_rm+0x1336>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    502e:	3b658593          	addi	a1,a1,950 # 83e0 <schedule_rm+0x6e6>
    5032:	853e                	mv	a0,a5
    ...
    504a:	c1250513          	addi	a0,a0,-1006 # 9c58 <schedule_rm+0x1f5e>
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    508e:	be650513          	addi	a0,a0,-1050 # 9c70 <schedule_rm+0x1f76>
    ...
    50a6:	bd650513          	addi	a0,a0,-1066 # 9c78 <schedule_rm+0x1f7e>
    ...
    50c0:	bb450513          	addi	a0,a0,-1100 # 9c70 <schedule_rm+0x1f76>
    ...
    50d8:	bbc50513          	addi	a0,a0,-1092 # 9c90 <schedule_rm+0x1f96>
    ...
    5150:	36c50513          	addi	a0,a0,876 # 84b8 <schedule_rm+0x7be>
    ...
    517e:	33e50513          	addi	a0,a0,830 # 84b8 <schedule_rm+0x7be>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    51ae:	93e50513          	addi	a0,a0,-1730 # 8ae8 <schedule_rm+0xdee>
    51b2:	00002097          	auipc	ra,0x2
    51b6:	f38080e7          	jalr	-200(ra) # 70ea <chdir>
    unlink("irefd");
    51ba:	00005517          	auipc	a0,0x5
    51be:	ab650513          	addi	a0,a0,-1354 # 9c70 <schedule_rm+0x1f76>
  ...
  chdir("/");
    ...
    51e8:	61c50513          	addi	a0,a0,1564 # 8800 <schedule_rm+0xb06>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    5268:	a4c50513          	addi	a0,a0,-1460 # 9cb0 <schedule_rm+0x1fb6>
  ...
  if(n == N){
    ...
    5296:	a3650513          	addi	a0,a0,-1482 # 9cc8 <schedule_rm+0x1fce>
  ...
  for(; n > 0; n--){
    ...
    52c4:	a3050513          	addi	a0,a0,-1488 # 9cf0 <schedule_rm+0x1ff6>
  ...
  if(wait(0) != -1){
    ...
    530a:	a0250513          	addi	a0,a0,-1534 # 9d08 <schedule_rm+0x200e>
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5352:	9d250513          	addi	a0,a0,-1582 # 9d20 <schedule_rm+0x2026>
  ...
  if(xstatus == 1){
    ...
    53f4:	95050513          	addi	a0,a0,-1712 # 9d40 <schedule_rm+0x2046>
  ...
  for(i = 0; i < 5000; i++){
    ...
    544a:	91a50513          	addi	a0,a0,-1766 # 9d60 <schedule_rm+0x2066>
    ...
    *b = 1;
    ...
    5464:	4705                	li	a4,1
    5466:	00e78023          	sb	a4,0(a5) # 40000000 <__BSS_END__+0x3ffef078>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    54b0:	8d450513          	addi	a0,a0,-1836 # 9d80 <schedule_rm+0x2086>
  ...
  if(c != a + 1){
    ...
    54f8:	8ac50513          	addi	a0,a0,-1876 # 9da0 <schedule_rm+0x20a6>
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    559c:	82850513          	addi	a0,a0,-2008 # 9dc0 <schedule_rm+0x20c6>
  ...
  *lastaddr = 99;
    ...
    55fe:	00e78023          	sb	a4,0(a5) # 6400000 <__BSS_END__+0x63ef078>
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5630:	7dc50513          	addi	a0,a0,2012 # 9e08 <schedule_rm+0x210e>
  ...
  if(c != a - PGSIZE){
    ...
    5674:	7b850513          	addi	a0,a0,1976 # 9e28 <schedule_rm+0x212e>
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    56da:	79250513          	addi	a0,a0,1938 # 9e68 <schedule_rm+0x216e>
  ...
  if(*lastaddr == 99){
    ...
    570a:	79250513          	addi	a0,a0,1938 # 9e98 <schedule_rm+0x219e>
  ...
  if(c != a){
    ...
    576c:	76850513          	addi	a0,a0,1896 # 9ed0 <schedule_rm+0x21d6>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    57c2:	f4a50513          	addi	a0,a0,-182 # 8708 <schedule_rm+0xa0e>
    ...
    57f8:	70450513          	addi	a0,a0,1796 # 9ef8 <schedule_rm+0x21fe>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    5838:	35078793          	addi	a5,a5,848 # c350 <__global_pointer$+0x1400>
    ...
    584c:	47f78793          	addi	a5,a5,1151 # 1003d47f <__BSS_END__+0x1002c4f7>
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5886:	31e50513          	addi	a0,a0,798 # 8ba0 <schedule_rm+0xea6>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    58fe:	ae658593          	addi	a1,a1,-1306 # 83e0 <schedule_rm+0x6e6>
    5902:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    59da:	54250513          	addi	a0,a0,1346 # 9f18 <schedule_rm+0x221e>
  ...
  if(pid < 0){
    ...
    5a10:	cfc50513          	addi	a0,a0,-772 # 8708 <schedule_rm+0xa0e>
  ...
  if(pid == 0){
    ...
    5a96:	4a650513          	addi	a0,a0,1190 # 9f38 <schedule_rm+0x223e>
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    5b08:	46450513          	addi	a0,a0,1124 # 9f68 <schedule_rm+0x226e>
  ...
  unlink("sbrk");
    ...
    5b1e:	44e50513          	addi	a0,a0,1102 # 9f68 <schedule_rm+0x226e>
  ...
  if(fd < 0)  {
    ...
    5b3c:	43850513          	addi	a0,a0,1080 # 9f70 <schedule_rm+0x2276>
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5b7e:	40e50513          	addi	a0,a0,1038 # 9f88 <schedule_rm+0x228e>
  ...
  if(pipe((int *) a) != 0){
    ...
    5bc8:	fdc50513          	addi	a0,a0,-36 # 8ba0 <schedule_rm+0xea6>
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    5c0c:	39850513          	addi	a0,a0,920 # 9fa0 <schedule_rm+0x22a6>
    ...
    5c2a:	38a50513          	addi	a0,a0,906 # 9fb0 <schedule_rm+0x22b6>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    5c7e:	ade70713          	addi	a4,a4,-1314 # d758 <uninit>
    ...
    5c96:	33e50513          	addi	a0,a0,830 # 9fd0 <schedule_rm+0x22d6>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    5ce2:	30a50513          	addi	a0,a0,778 # 9fe8 <schedule_rm+0x22ee>
  ...
  if(pid == 0){
    ...
    5da4:	33850513          	addi	a0,a0,824 # a0d8 <schedule_rm+0x23de>
  ...
  fd = open("bigarg-ok", 0);
    ...
    5de2:	20a50513          	addi	a0,a0,522 # 9fe8 <schedule_rm+0x22ee>
  ...
  if(fd < 0){
    ...
    5e06:	2f650513          	addi	a0,a0,758 # a0f8 <schedule_rm+0x23fe>
...
fsfull()
{
  ...
  printf("fsfull test\n");
    ...
    5e44:	2d850513          	addi	a0,a0,728 # a118 <schedule_rm+0x241e>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ef6:	23650513          	addi	a0,a0,566 # a128 <schedule_rm+0x242e>
    ...
    5f2e:	20e50513          	addi	a0,a0,526 # a138 <schedule_rm+0x243e>
    ...
    5f4c:	81058593          	addi	a1,a1,-2032 # a758 <buf>
    5f50:	853e                	mv	a0,a5
    ...
    5f96:	1b650513          	addi	a0,a0,438 # a148 <schedule_rm+0x244e>
  ...
  printf("fsfull test finished\n");
    ...
    6086:	0d650513          	addi	a0,a0,214 # a158 <schedule_rm+0x245e>
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    ...
    60ae:	0c650513          	addi	a0,a0,198 # a170 <schedule_rm+0x2476>
  ...
  if (fd < 0) {
    ...
    60d2:	65250513          	addi	a0,a0,1618 # 8720 <schedule_rm+0xa26>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    612c:	62878793          	addi	a5,a5,1576 # a750 <randstate>
    6130:	6398                	ld	a4,0(a5)
    6132:	001967b7          	lui	a5,0x196
    6136:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x185685>
    613a:	02f70733          	mul	a4,a4,a5
    613e:	3c6ef7b7          	lui	a5,0x3c6ef
    6142:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6de3d7>
    6146:	973e                	add	a4,a4,a5
    6148:	00004797          	auipc	a5,0x4
    614c:	60878793          	addi	a5,a5,1544 # a750 <randstate>
    6150:	e398                	sd	a4,0(a5)
  return randstate;
    6152:	00004797          	auipc	a5,0x4
    6156:	5fe78793          	addi	a5,a5,1534 # a750 <randstate>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    61a6:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffee078>
    61aa:	2781                	sext.w	a5,a5
    61ac:	863e                	mv	a2,a5
    61ae:	fc843583          	ld	a1,-56(s0)
    61b2:	00004517          	auipc	a0,0x4
    61b6:	fc650513          	addi	a0,a0,-58 # a178 <schedule_rm+0x247e>
    ...
    61de:	52e50513          	addi	a0,a0,1326 # 8708 <schedule_rm+0xa0e>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    623e:	4ee78793          	addi	a5,a5,1262 # a728 <schedule_rm+0x2a2e>
  ...
  pipe((int*)0xeaeb0b5b00002f5e);
    ...
    6254:	4d878793          	addi	a5,a5,1240 # a728 <schedule_rm+0x2a2e>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    6296:	24e50513          	addi	a0,a0,590 # 84e0 <schedule_rm+0x7e6>
  ...
  if(pid < 0){
    ...
    6308:	1dc50513          	addi	a0,a0,476 # 84e0 <schedule_rm+0x7e6>
  ...
  if(pid < 0){
    ...
    6380:	16450513          	addi	a0,a0,356 # 84e0 <schedule_rm+0x7e6>
...
badwrite(char *s)
{
  ...
  unlink("junk");
    ...
    6404:	da050513          	addi	a0,a0,-608 # a1a0 <schedule_rm+0x24a6>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    641e:	d8650513          	addi	a0,a0,-634 # a1a0 <schedule_rm+0x24a6>
    ...
    643e:	d6e50513          	addi	a0,a0,-658 # a1a8 <schedule_rm+0x24ae>
    ...
    647c:	d2850513          	addi	a0,a0,-728 # a1a0 <schedule_rm+0x24a6>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    64aa:	cfa50513          	addi	a0,a0,-774 # a1a0 <schedule_rm+0x24a6>
  ...
  if(fd < 0){
    ...
    64ca:	ce250513          	addi	a0,a0,-798 # a1a8 <schedule_rm+0x24ae>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    64ea:	efa58593          	addi	a1,a1,-262 # 83e0 <schedule_rm+0x6e6>
    64ee:	853e                	mv	a0,a5
    ...
    6506:	cbe50513          	addi	a0,a0,-834 # a1c0 <schedule_rm+0x24c6>
  ...
  unlink("junk");
    ...
    652e:	c7650513          	addi	a0,a0,-906 # a1a0 <schedule_rm+0x24a6>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    656c:	f8850513          	addi	a0,a0,-120 # 84f0 <schedule_rm+0x7f6>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    658c:	34f78793          	addi	a5,a5,847 # c34f <__global_pointer$+0x13ff>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    65cc:	f1850513          	addi	a0,a0,-232 # 84e0 <schedule_rm+0x7e6>
    ...
    660e:	873e                	mv	a4,a5
    6610:	4785                	li	a5,1
    6612:	00f70023          	sb	a5,0(a4) # b000 <__global_pointer$+0xb0>
      while(1){
    ...
    6652:	ea278793          	addi	a5,a5,-350 # 84f0 <schedule_rm+0x7f6>
    6656:	fcf43023          	sd	a5,-64(s0)
    665a:	00002797          	auipc	a5,0x2
    665e:	d8678793          	addi	a5,a5,-634 # 83e0 <schedule_rm+0x6e6>
    ...
    6674:	e8050513          	addi	a0,a0,-384 # 84f0 <schedule_rm+0x7f6>
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    66d6:	afe50513          	addi	a0,a0,-1282 # a1d0 <schedule_rm+0x24d6>
  ...
  if(pid < 0){
    ...
    6708:	aec50513          	addi	a0,a0,-1300 # a1f0 <schedule_rm+0x24f6>
  ...
  if(pid == 0){
    ...
    676a:	c7a58593          	addi	a1,a1,-902 # 83e0 <schedule_rm+0x6e6>
    676e:	853e                	mv	a0,a5
    ...
    6786:	a8e50513          	addi	a0,a0,-1394 # a210 <schedule_rm+0x2516>
  ...
  while(1){
    ...
    67e4:	a5050513          	addi	a0,a0,-1456 # a230 <schedule_rm+0x2536>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    684e:	a0650513          	addi	a0,a0,-1530 # a250 <schedule_rm+0x2556>
  ...
  if((pid = fork()) < 0) {
    ...
    6876:	9ee50513          	addi	a0,a0,-1554 # a260 <schedule_rm+0x2566>
  ...
  if(pid == 0) {
    ...
    68c0:	9bc50513          	addi	a0,a0,-1604 # a278 <schedule_rm+0x257e>
    ...
    68d2:	9b250513          	addi	a0,a0,-1614 # a280 <schedule_rm+0x2586>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    6932:	95a58593          	addi	a1,a1,-1702 # a288 <schedule_rm+0x258e>
    6936:	853e                	mv	a0,a5
    ...
    6966:	92e58593          	addi	a1,a1,-1746 # a290 <schedule_rm+0x2596>
    696a:	853e                	mv	a0,a5
    ...
    69c2:	8da50513          	addi	a0,a0,-1830 # a298 <schedule_rm+0x259e>
  ...
  struct test {
    ...
    69dc:	9a070713          	addi	a4,a4,-1632 # a378 <schedule_rm+0x267e>
  ...
  if(continuous){
    ...
    6a04:	8c050513          	addi	a0,a0,-1856 # a2c0 <schedule_rm+0x25c6>
    ...
    6a6e:	87650513          	addi	a0,a0,-1930 # a2e0 <schedule_rm+0x25e6>
    ...
    6ac4:	83850513          	addi	a0,a0,-1992 # a2f8 <schedule_rm+0x25fe>
  ...
  printf("usertests starting\n");
    ...
    6aec:	83050513          	addi	a0,a0,-2000 # a318 <schedule_rm+0x261e>
  ...
  if(fail){
    ...
    6b76:	76e50513          	addi	a0,a0,1902 # a2e0 <schedule_rm+0x25e6>
    ...
    6bba:	77a50513          	addi	a0,a0,1914 # a330 <schedule_rm+0x2636>
    ...
    6bd4:	79050513          	addi	a0,a0,1936 # a360 <schedule_rm+0x2666>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    71e2:	55a68693          	addi	a3,a3,1370 # a738 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    72bc:	48070713          	addi	a4,a4,1152 # a738 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    747c:	2b878793          	addi	a5,a5,696 # a730 <schedule_rm+0x2a36>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    7628:	95c78793          	addi	a5,a5,-1700 # 10f80 <freep>
  ...
  freep = p;
    ...
    7720:	86478793          	addi	a5,a5,-1948 # 10f80 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    77a2:	7e278793          	addi	a5,a5,2018 # 10f80 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    77d4:	7b078793          	addi	a5,a5,1968 # 10f80 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    7892:	6f278793          	addi	a5,a5,1778 # 10f80 <freep>
    ...
    78a8:	6dc78793          	addi	a5,a5,1756 # 10f80 <freep>
...
struct threads_sched_result schedule_default(struct threads_sched_args args)
{
    ...
    7998:	5398                	lw	a4,32(a5)
    799a:	fe843783          	ld	a5,-24(s0)
    799e:	539c                	lw	a5,32(a5)
    ...
    7a0a:	fc043703          	ld	a4,-64(s0)
    7a0e:	fc843783          	ld	a5,-56(s0)
    7a12:	863a                	mv	a2,a4
    7a14:	86be                	mv	a3,a5
    7a16:	8732                	mv	a4,a2
    7a18:	87b6                	mv	a5,a3
    ...
    7a1a:	853a                	mv	a0,a4
    7a1c:	85be                	mv	a1,a5
    7a1e:	6426                	ld	s0,72(sp)
    7a20:	6486                	ld	s1,64(sp)
    7a22:	6161                	addi	sp,sp,80
    7a24:	8082                	ret

0000000000007a26 <schedule_edf>:

/* Earliest-Deadline-First scheduling */
struct threads_sched_result schedule_edf(struct threads_sched_args args)
{   
    7a26:	7171                	addi	sp,sp,-176
    7a28:	f522                	sd	s0,168(sp)
    7a2a:	f126                	sd	s1,160(sp)
    7a2c:	1900                	addi	s0,sp,176
    7a2e:	84aa                	mv	s1,a0
    int is_miss = 0;
    7a30:	fe042623          	sw	zero,-20(s0)
    struct thread *tws_deadline = NULL, *tws_id = NULL;
    7a34:	fe043023          	sd	zero,-32(s0)
    7a38:	fc043c23          	sd	zero,-40(s0)
    struct thread *th = NULL;
    7a3c:	fc043823          	sd	zero,-48(s0)
    
    list_for_each_entry(th, args.run_queue, thread_list) {
    7a40:	649c                	ld	a5,8(s1)
    7a42:	639c                	ld	a5,0(a5)
    7a44:	faf43423          	sd	a5,-88(s0)
    7a48:	fa843783          	ld	a5,-88(s0)
    7a4c:	fd878793          	addi	a5,a5,-40
    7a50:	fcf43823          	sd	a5,-48(s0)
    7a54:	a895                	j	7ac8 <schedule_edf+0xa2>
        if(args.current_time + th->remaining_time > th->current_deadline){
    7a56:	4098                	lw	a4,0(s1)
    7a58:	fd043783          	ld	a5,-48(s0)
    7a5c:	47fc                	lw	a5,76(a5)
    7a5e:	9fb9                	addw	a5,a5,a4
    7a60:	0007871b          	sext.w	a4,a5
    7a64:	fd043783          	ld	a5,-48(s0)
    7a68:	4bbc                	lw	a5,80(a5)
    7a6a:	00e7d563          	bge	a5,a4,7a74 <schedule_edf+0x4e>
            is_miss = 1;
    7a6e:	4785                	li	a5,1
    ...
    7a74:	fe043783          	ld	a5,-32(s0)
    7a78:	cb8d                	beqz	a5,7aaa <schedule_edf+0x84>
    7a7a:	fd043783          	ld	a5,-48(s0)
    7a7e:	4bb8                	lw	a4,80(a5)
    7a80:	fe043783          	ld	a5,-32(s0)
    7a84:	4bbc                	lw	a5,80(a5)
    7a86:	02f74263          	blt	a4,a5,7aaa <schedule_edf+0x84>
    7a8a:	fd043783          	ld	a5,-48(s0)
    7a8e:	4bb8                	lw	a4,80(a5)
    7a90:	fe043783          	ld	a5,-32(s0)
    7a94:	4bbc                	lw	a5,80(a5)
    7a96:	00f71e63          	bne	a4,a5,7ab2 <schedule_edf+0x8c>
    7a9a:	fd043783          	ld	a5,-48(s0)
    7a9e:	5398                	lw	a4,32(a5)
    7aa0:	fe043783          	ld	a5,-32(s0)
    7aa4:	539c                	lw	a5,32(a5)
    7aa6:	00f75663          	bge	a4,a5,7ab2 <schedule_edf+0x8c>
            tws_deadline = th;
    7aaa:	fd043783          	ld	a5,-48(s0)
    7aae:	fef43023          	sd	a5,-32(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    7ab2:	fd043783          	ld	a5,-48(s0)
    7ab6:	779c                	ld	a5,40(a5)
    7ab8:	f6f43823          	sd	a5,-144(s0)
    7abc:	f7043783          	ld	a5,-144(s0)
    7ac0:	fd878793          	addi	a5,a5,-40
    7ac4:	fcf43823          	sd	a5,-48(s0)
    7ac8:	fd043783          	ld	a5,-48(s0)
    7acc:	02878713          	addi	a4,a5,40
    7ad0:	649c                	ld	a5,8(s1)
    7ad2:	f8f712e3          	bne	a4,a5,7a56 <schedule_edf+0x30>
        }
    }
    
    struct threads_sched_result r;
    if (tws_deadline != NULL) {
    7ad6:	fe043783          	ld	a5,-32(s0)
    7ada:	18078063          	beqz	a5,7c5a <schedule_edf+0x234>
        if(!is_miss){
    7ade:	fec42783          	lw	a5,-20(s0)
    7ae2:	2781                	sext.w	a5,a5
    7ae4:	e3ed                	bnez	a5,7bc6 <schedule_edf+0x1a0>
            r.scheduled_thread_list_member = &tws_deadline->thread_list;
    7ae6:	fe043783          	ld	a5,-32(s0)
    7aea:	02878793          	addi	a5,a5,40
    7aee:	f4f43823          	sd	a5,-176(s0)
            struct release_queue_entry *rth;
            struct thread *find = NULL;
    7af2:	fc043023          	sd	zero,-64(s0)
            list_for_each_entry(rth, args.release_queue, thread_list){
    7af6:	689c                	ld	a5,16(s1)
    7af8:	639c                	ld	a5,0(a5)
    7afa:	f8f43023          	sd	a5,-128(s0)
    7afe:	f8043783          	ld	a5,-128(s0)
    7b02:	17e1                	addi	a5,a5,-8
    7b04:	fcf43423          	sd	a5,-56(s0)
    7b08:	a88d                	j	7b7a <schedule_edf+0x154>
    ...
    7b0a:	fc843783          	ld	a5,-56(s0)
    7b0e:	639c                	ld	a5,0(a5)
    7b10:	4bb8                	lw	a4,80(a5)
    7b12:	fc843783          	ld	a5,-56(s0)
    7b16:	639c                	ld	a5,0(a5)
    7b18:	43fc                	lw	a5,68(a5)
    7b1a:	9fb9                	addw	a5,a5,a4
    7b1c:	0007871b          	sext.w	a4,a5
    7b20:	fe043783          	ld	a5,-32(s0)
    7b24:	4bbc                	lw	a5,80(a5)
    7b26:	04f75063          	bge	a4,a5,7b66 <schedule_edf+0x140>
    7b2a:	fc043783          	ld	a5,-64(s0)
    7b2e:	c79d                	beqz	a5,7b5c <schedule_edf+0x136>
    7b30:	fc843783          	ld	a5,-56(s0)
    7b34:	639c                	ld	a5,0(a5)
    7b36:	4bb8                	lw	a4,80(a5)
    7b38:	fc843783          	ld	a5,-56(s0)
    7b3c:	639c                	ld	a5,0(a5)
    7b3e:	43fc                	lw	a5,68(a5)
    7b40:	9fb9                	addw	a5,a5,a4
    7b42:	0007859b          	sext.w	a1,a5
    7b46:	fc043783          	ld	a5,-64(s0)
    7b4a:	4bb8                	lw	a4,80(a5)
    7b4c:	fc043783          	ld	a5,-64(s0)
    7b50:	43fc                	lw	a5,68(a5)
    7b52:	9fb9                	addw	a5,a5,a4
    7b54:	2781                	sext.w	a5,a5
    7b56:	872e                	mv	a4,a1
    7b58:	00f75763          	bge	a4,a5,7b66 <schedule_edf+0x140>
                    find = rth->thrd;
    7b5c:	fc843783          	ld	a5,-56(s0)
    7b60:	639c                	ld	a5,0(a5)
    7b62:	fcf43023          	sd	a5,-64(s0)
            list_for_each_entry(rth, args.release_queue, thread_list){
    7b66:	fc843783          	ld	a5,-56(s0)
    7b6a:	679c                	ld	a5,8(a5)
    7b6c:	f6f43c23          	sd	a5,-136(s0)
    7b70:	f7843783          	ld	a5,-136(s0)
    7b74:	17e1                	addi	a5,a5,-8
    7b76:	fcf43423          	sd	a5,-56(s0)
    7b7a:	fc843783          	ld	a5,-56(s0)
    7b7e:	00878713          	addi	a4,a5,8
    7b82:	689c                	ld	a5,16(s1)
    7b84:	f8f713e3          	bne	a4,a5,7b0a <schedule_edf+0xe4>
                }
            }
    ...
    7b8c:	cf89                	beqz	a5,7ba6 <schedule_edf+0x180>
    7b8e:	4098                	lw	a4,0(s1)
    7b90:	fe043783          	ld	a5,-32(s0)
    7b94:	47fc                	lw	a5,76(a5)
    7b96:	9fb9                	addw	a5,a5,a4
    7b98:	0007871b          	sext.w	a4,a5
    7b9c:	fc043783          	ld	a5,-64(s0)
    7ba0:	4bbc                	lw	a5,80(a5)
    7ba2:	00e7c863          	blt	a5,a4,7bb2 <schedule_edf+0x18c>
    7ba6:	fe043783          	ld	a5,-32(s0)
    7baa:	47fc                	lw	a5,76(a5)
    7bac:	f4f42c23          	sw	a5,-168(s0)
    7bb0:	aa39                	j	7cce <schedule_edf+0x2a8>
            else{
                //r.allocated_time = tws_deadline->remaining_time;
                r.allocated_time = find->current_deadline - args.current_time;
    7bb2:	fc043783          	ld	a5,-64(s0)
    7bb6:	4bb8                	lw	a4,80(a5)
    7bb8:	409c                	lw	a5,0(s1)
    7bba:	40f707bb          	subw	a5,a4,a5
    7bbe:	2781                	sext.w	a5,a5
    7bc0:	f4f42c23          	sw	a5,-168(s0)
    7bc4:	a229                	j	7cce <schedule_edf+0x2a8>
            }
        }
        else{
            list_for_each_entry(th, args.run_queue, thread_list) {
    7bc6:	649c                	ld	a5,8(s1)
    7bc8:	639c                	ld	a5,0(a5)
    7bca:	f8f43823          	sd	a5,-112(s0)
    7bce:	f9043783          	ld	a5,-112(s0)
    7bd2:	fd878793          	addi	a5,a5,-40
    7bd6:	fcf43823          	sd	a5,-48(s0)
    7bda:	a089                	j	7c1c <schedule_edf+0x1f6>
                if (tws_id == NULL || (args.current_time >= th->current_deadline && th->ID < tws_id->ID)) {
    7bdc:	fd843783          	ld	a5,-40(s0)
    7be0:	cf99                	beqz	a5,7bfe <schedule_edf+0x1d8>
    7be2:	4098                	lw	a4,0(s1)
    7be4:	fd043783          	ld	a5,-48(s0)
    7be8:	4bbc                	lw	a5,80(a5)
    7bea:	00f74e63          	blt	a4,a5,7c06 <schedule_edf+0x1e0>
    7bee:	fd043783          	ld	a5,-48(s0)
    7bf2:	5398                	lw	a4,32(a5)
    7bf4:	fd843783          	ld	a5,-40(s0)
    7bf8:	539c                	lw	a5,32(a5)
    7bfa:	00f75663          	bge	a4,a5,7c06 <schedule_edf+0x1e0>
                    tws_id = th;
    7bfe:	fd043783          	ld	a5,-48(s0)
    7c02:	fcf43c23          	sd	a5,-40(s0)
            list_for_each_entry(th, args.run_queue, thread_list) {
    7c06:	fd043783          	ld	a5,-48(s0)
    7c0a:	779c                	ld	a5,40(a5)
    7c0c:	f8f43423          	sd	a5,-120(s0)
    7c10:	f8843783          	ld	a5,-120(s0)
    7c14:	fd878793          	addi	a5,a5,-40
    7c18:	fcf43823          	sd	a5,-48(s0)
    7c1c:	fd043783          	ld	a5,-48(s0)
    7c20:	02878713          	addi	a4,a5,40
    7c24:	649c                	ld	a5,8(s1)
    7c26:	faf71be3          	bne	a4,a5,7bdc <schedule_edf+0x1b6>
                }
            }
            r.scheduled_thread_list_member = &tws_id->thread_list;
    7c2a:	fd843783          	ld	a5,-40(s0)
    7c2e:	02878793          	addi	a5,a5,40
    7c32:	f4f43823          	sd	a5,-176(s0)
            r.allocated_time = (tws_id->current_deadline - args.current_time < 0)? 0: tws_id->current_deadline - args.current_time;
    7c36:	fd843783          	ld	a5,-40(s0)
    7c3a:	4bb8                	lw	a4,80(a5)
    7c3c:	409c                	lw	a5,0(s1)
    7c3e:	40f707bb          	subw	a5,a4,a5
    7c42:	2781                	sext.w	a5,a5
    7c44:	873e                	mv	a4,a5
    7c46:	0007079b          	sext.w	a5,a4
    7c4a:	0007d363          	bgez	a5,7c50 <schedule_edf+0x22a>
    7c4e:	4701                	li	a4,0
    7c50:	0007079b          	sext.w	a5,a4
    7c54:	f4f42c23          	sw	a5,-168(s0)
    7c58:	a89d                	j	7cce <schedule_edf+0x2a8>
        }
        
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    7c5a:	649c                	ld	a5,8(s1)
    7c5c:	f4f43823          	sd	a5,-176(s0)
            struct release_queue_entry *rth;
            struct thread *find = NULL;
    7c60:	fa043823          	sd	zero,-80(s0)
            list_for_each_entry(rth, args.release_queue, thread_list) {
    7c64:	689c                	ld	a5,16(s1)
    7c66:	639c                	ld	a5,0(a5)
    7c68:	faf43023          	sd	a5,-96(s0)
    7c6c:	fa043783          	ld	a5,-96(s0)
    7c70:	17e1                	addi	a5,a5,-8
    7c72:	faf43c23          	sd	a5,-72(s0)
    7c76:	a825                	j	7cae <schedule_edf+0x288>
            if (find == NULL || (rth->thrd->current_deadline < find->current_deadline)) {
    7c78:	fb043783          	ld	a5,-80(s0)
    7c7c:	cb91                	beqz	a5,7c90 <schedule_edf+0x26a>
    7c7e:	fb843783          	ld	a5,-72(s0)
    7c82:	639c                	ld	a5,0(a5)
    7c84:	4bb8                	lw	a4,80(a5)
    7c86:	fb043783          	ld	a5,-80(s0)
    7c8a:	4bbc                	lw	a5,80(a5)
    7c8c:	00f75763          	bge	a4,a5,7c9a <schedule_edf+0x274>
                find = rth->thrd;
    7c90:	fb843783          	ld	a5,-72(s0)
    7c94:	639c                	ld	a5,0(a5)
    7c96:	faf43823          	sd	a5,-80(s0)
            list_for_each_entry(rth, args.release_queue, thread_list) {
    7c9a:	fb843783          	ld	a5,-72(s0)
    7c9e:	679c                	ld	a5,8(a5)
    7ca0:	f8f43c23          	sd	a5,-104(s0)
    7ca4:	f9843783          	ld	a5,-104(s0)
    7ca8:	17e1                	addi	a5,a5,-8
    7caa:	faf43c23          	sd	a5,-72(s0)
    7cae:	fb843783          	ld	a5,-72(s0)
    7cb2:	00878713          	addi	a4,a5,8
    7cb6:	689c                	ld	a5,16(s1)
    7cb8:	fcf710e3          	bne	a4,a5,7c78 <schedule_edf+0x252>
            }
        }
        r.allocated_time = find->current_deadline - args.current_time;
    7cbc:	fb043783          	ld	a5,-80(s0)
    7cc0:	4bb8                	lw	a4,80(a5)
    7cc2:	409c                	lw	a5,0(s1)
    7cc4:	40f707bb          	subw	a5,a4,a5
    7cc8:	2781                	sext.w	a5,a5
    7cca:	f4f42c23          	sw	a5,-168(s0)
    }

    return r;
    7cce:	f5043783          	ld	a5,-176(s0)
    7cd2:	f6f43023          	sd	a5,-160(s0)
    7cd6:	f5843783          	ld	a5,-168(s0)
    7cda:	f6f43423          	sd	a5,-152(s0)
    7cde:	f6043703          	ld	a4,-160(s0)
    7ce2:	f6843783          	ld	a5,-152(s0)
    7ce6:	863a                	mv	a2,a4
    7ce8:	86be                	mv	a3,a5
    7cea:	8732                	mv	a4,a2
    7cec:	87b6                	mv	a5,a3
    ...
    7cee:	853a                	mv	a0,a4
    7cf0:	85be                	mv	a1,a5
    7cf2:	742a                	ld	s0,168(sp)
    7cf4:	748a                	ld	s1,160(sp)
    7cf6:	614d                	addi	sp,sp,176
    7cf8:	8082                	ret

0000000000007cfa <schedule_rm>:

/* Rate-Monotonic Scheduling */
struct threads_sched_result schedule_rm(struct threads_sched_args args)
{
    7cfa:	7171                	addi	sp,sp,-176
    7cfc:	f522                	sd	s0,168(sp)
    7cfe:	f126                	sd	s1,160(sp)
    7d00:	1900                	addi	s0,sp,176
    7d02:	84aa                	mv	s1,a0
    int is_miss = 0;
    7d04:	fe042623          	sw	zero,-20(s0)
    struct thread *tws_period = NULL, *tws_id = NULL;
    7d08:	fe043023          	sd	zero,-32(s0)
    7d0c:	fc043c23          	sd	zero,-40(s0)
    struct thread *th = NULL;
    7d10:	fc043823          	sd	zero,-48(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    7d14:	649c                	ld	a5,8(s1)
    7d16:	639c                	ld	a5,0(a5)
    7d18:	faf43423          	sd	a5,-88(s0)
    7d1c:	fa843783          	ld	a5,-88(s0)
    7d20:	fd878793          	addi	a5,a5,-40
    7d24:	fcf43823          	sd	a5,-48(s0)
    7d28:	a895                	j	7d9c <schedule_rm+0xa2>
        if(args.current_time + th->remaining_time > th->current_deadline){
    7d2a:	4098                	lw	a4,0(s1)
    7d2c:	fd043783          	ld	a5,-48(s0)
    7d30:	47fc                	lw	a5,76(a5)
    7d32:	9fb9                	addw	a5,a5,a4
    7d34:	0007871b          	sext.w	a4,a5
    7d38:	fd043783          	ld	a5,-48(s0)
    7d3c:	4bbc                	lw	a5,80(a5)
    7d3e:	00e7d563          	bge	a5,a4,7d48 <schedule_rm+0x4e>
            is_miss = 1;
    7d42:	4785                	li	a5,1
    7d44:	fef42623          	sw	a5,-20(s0)
            //break;
        }
        if (tws_period == NULL || (th->period < tws_period->period) || (th->period == tws_period->period && th->ID < tws_period->ID)) {
    7d48:	fe043783          	ld	a5,-32(s0)
    7d4c:	cb8d                	beqz	a5,7d7e <schedule_rm+0x84>
    7d4e:	fd043783          	ld	a5,-48(s0)
    7d52:	43f8                	lw	a4,68(a5)
    7d54:	fe043783          	ld	a5,-32(s0)
    7d58:	43fc                	lw	a5,68(a5)
    7d5a:	02f74263          	blt	a4,a5,7d7e <schedule_rm+0x84>
    7d5e:	fd043783          	ld	a5,-48(s0)
    7d62:	43f8                	lw	a4,68(a5)
    7d64:	fe043783          	ld	a5,-32(s0)
    7d68:	43fc                	lw	a5,68(a5)
    7d6a:	00f71e63          	bne	a4,a5,7d86 <schedule_rm+0x8c>
    7d6e:	fd043783          	ld	a5,-48(s0)
    7d72:	5398                	lw	a4,32(a5)
    7d74:	fe043783          	ld	a5,-32(s0)
    7d78:	539c                	lw	a5,32(a5)
    7d7a:	00f75663          	bge	a4,a5,7d86 <schedule_rm+0x8c>
            tws_period = th;
    7d7e:	fd043783          	ld	a5,-48(s0)
    7d82:	fef43023          	sd	a5,-32(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    7d86:	fd043783          	ld	a5,-48(s0)
    7d8a:	779c                	ld	a5,40(a5)
    7d8c:	f6f43823          	sd	a5,-144(s0)
    7d90:	f7043783          	ld	a5,-144(s0)
    7d94:	fd878793          	addi	a5,a5,-40
    7d98:	fcf43823          	sd	a5,-48(s0)
    7d9c:	fd043783          	ld	a5,-48(s0)
    7da0:	02878713          	addi	a4,a5,40
    7da4:	649c                	ld	a5,8(s1)
    7da6:	f8f712e3          	bne	a4,a5,7d2a <schedule_rm+0x30>
        }
    }

    struct threads_sched_result r; 
    if (tws_period != NULL) {
    7daa:	fe043783          	ld	a5,-32(s0)
    7dae:	16078063          	beqz	a5,7f0e <schedule_rm+0x214>
        if(!is_miss){
    7db2:	fec42783          	lw	a5,-20(s0)
    7db6:	2781                	sext.w	a5,a5
    7db8:	e3e9                	bnez	a5,7e7a <schedule_rm+0x180>
            r.scheduled_thread_list_member = &tws_period->thread_list;
    7dba:	fe043783          	ld	a5,-32(s0)
    7dbe:	02878793          	addi	a5,a5,40
    7dc2:	f4f43823          	sd	a5,-176(s0)
            struct release_queue_entry *rth;
            struct thread *find = NULL;
    7dc6:	fc043023          	sd	zero,-64(s0)
            list_for_each_entry(rth, args.release_queue, thread_list){
    7dca:	689c                	ld	a5,16(s1)
    7dcc:	639c                	ld	a5,0(a5)
    7dce:	f8f43023          	sd	a5,-128(s0)
    7dd2:	f8043783          	ld	a5,-128(s0)
    7dd6:	17e1                	addi	a5,a5,-8
    7dd8:	fcf43423          	sd	a5,-56(s0)
    7ddc:	a889                	j	7e2e <schedule_rm+0x134>
                if(find == NULL || rth->thrd->current_deadline + rth->thrd->period < find->current_deadline + find->period) {
    7dde:	fc043783          	ld	a5,-64(s0)
    7de2:	c79d                	beqz	a5,7e10 <schedule_rm+0x116>
    7de4:	fc843783          	ld	a5,-56(s0)
    7de8:	639c                	ld	a5,0(a5)
    7dea:	4bb8                	lw	a4,80(a5)
    7dec:	fc843783          	ld	a5,-56(s0)
    7df0:	639c                	ld	a5,0(a5)
    7df2:	43fc                	lw	a5,68(a5)
    7df4:	9fb9                	addw	a5,a5,a4
    7df6:	0007859b          	sext.w	a1,a5
    7dfa:	fc043783          	ld	a5,-64(s0)
    7dfe:	4bb8                	lw	a4,80(a5)
    7e00:	fc043783          	ld	a5,-64(s0)
    7e04:	43fc                	lw	a5,68(a5)
    7e06:	9fb9                	addw	a5,a5,a4
    7e08:	2781                	sext.w	a5,a5
    7e0a:	872e                	mv	a4,a1
    7e0c:	00f75763          	bge	a4,a5,7e1a <schedule_rm+0x120>
                    find = rth->thrd;
    7e10:	fc843783          	ld	a5,-56(s0)
    7e14:	639c                	ld	a5,0(a5)
    7e16:	fcf43023          	sd	a5,-64(s0)
            list_for_each_entry(rth, args.release_queue, thread_list){
    7e1a:	fc843783          	ld	a5,-56(s0)
    7e1e:	679c                	ld	a5,8(a5)
    7e20:	f6f43c23          	sd	a5,-136(s0)
    7e24:	f7843783          	ld	a5,-136(s0)
    7e28:	17e1                	addi	a5,a5,-8
    7e2a:	fcf43423          	sd	a5,-56(s0)
    7e2e:	fc843783          	ld	a5,-56(s0)
    7e32:	00878713          	addi	a4,a5,8
    7e36:	689c                	ld	a5,16(s1)
    7e38:	faf713e3          	bne	a4,a5,7dde <schedule_rm+0xe4>
                }
            }
    ...
    7e3c:	fc043783          	ld	a5,-64(s0)
    7e40:	cf89                	beqz	a5,7e5a <schedule_rm+0x160>
    7e42:	4098                	lw	a4,0(s1)
    7e44:	fe043783          	ld	a5,-32(s0)
    7e48:	47fc                	lw	a5,76(a5)
    7e4a:	9fb9                	addw	a5,a5,a4
    7e4c:	0007871b          	sext.w	a4,a5
    7e50:	fc043783          	ld	a5,-64(s0)
    7e54:	4bbc                	lw	a5,80(a5)
    7e56:	00e7c863          	blt	a5,a4,7e66 <schedule_rm+0x16c>
    7e5a:	fe043783          	ld	a5,-32(s0)
    7e5e:	47fc                	lw	a5,76(a5)
    7e60:	f4f42c23          	sw	a5,-168(s0)
    7e64:	aa39                	j	7f82 <schedule_rm+0x288>
            else{
                //r.allocated_time = tws_period->remaining_time;
                r.allocated_time = find->current_deadline - args.current_time;
    7e66:	fc043783          	ld	a5,-64(s0)
    7e6a:	4bb8                	lw	a4,80(a5)
    7e6c:	409c                	lw	a5,0(s1)
    7e6e:	40f707bb          	subw	a5,a4,a5
    7e72:	2781                	sext.w	a5,a5
    7e74:	f4f42c23          	sw	a5,-168(s0)
    7e78:	a229                	j	7f82 <schedule_rm+0x288>
            }
        }
        else{
            list_for_each_entry(th, args.run_queue, thread_list) {
    7e7a:	649c                	ld	a5,8(s1)
    7e7c:	639c                	ld	a5,0(a5)
    7e7e:	f8f43823          	sd	a5,-112(s0)
    7e82:	f9043783          	ld	a5,-112(s0)
    7e86:	fd878793          	addi	a5,a5,-40
    7e8a:	fcf43823          	sd	a5,-48(s0)
    7e8e:	a089                	j	7ed0 <schedule_rm+0x1d6>
                if (tws_id == NULL || (args.current_time >= th->current_deadline && th->ID < tws_id->ID)) {
    7e90:	fd843783          	ld	a5,-40(s0)
    7e94:	cf99                	beqz	a5,7eb2 <schedule_rm+0x1b8>
    7e96:	4098                	lw	a4,0(s1)
    7e98:	fd043783          	ld	a5,-48(s0)
    7e9c:	4bbc                	lw	a5,80(a5)
    7e9e:	00f74e63          	blt	a4,a5,7eba <schedule_rm+0x1c0>
    7ea2:	fd043783          	ld	a5,-48(s0)
    7ea6:	5398                	lw	a4,32(a5)
    7ea8:	fd843783          	ld	a5,-40(s0)
    7eac:	539c                	lw	a5,32(a5)
    7eae:	00f75663          	bge	a4,a5,7eba <schedule_rm+0x1c0>
                    tws_id = th;
    7eb2:	fd043783          	ld	a5,-48(s0)
    7eb6:	fcf43c23          	sd	a5,-40(s0)
            list_for_each_entry(th, args.run_queue, thread_list) {
    7eba:	fd043783          	ld	a5,-48(s0)
    7ebe:	779c                	ld	a5,40(a5)
    7ec0:	f8f43423          	sd	a5,-120(s0)
    7ec4:	f8843783          	ld	a5,-120(s0)
    7ec8:	fd878793          	addi	a5,a5,-40
    7ecc:	fcf43823          	sd	a5,-48(s0)
    7ed0:	fd043783          	ld	a5,-48(s0)
    7ed4:	02878713          	addi	a4,a5,40
    7ed8:	649c                	ld	a5,8(s1)
    7eda:	faf71be3          	bne	a4,a5,7e90 <schedule_rm+0x196>
                }
            }
            r.scheduled_thread_list_member = &tws_id->thread_list;
    7ede:	fd843783          	ld	a5,-40(s0)
    7ee2:	02878793          	addi	a5,a5,40
    7ee6:	f4f43823          	sd	a5,-176(s0)
            r.allocated_time = (tws_id->current_deadline - args.current_time < 0)? 0: tws_id->current_deadline - args.current_time;
    7eea:	fd843783          	ld	a5,-40(s0)
    7eee:	4bb8                	lw	a4,80(a5)
    7ef0:	409c                	lw	a5,0(s1)
    7ef2:	40f707bb          	subw	a5,a4,a5
    7ef6:	2781                	sext.w	a5,a5
    7ef8:	873e                	mv	a4,a5
    7efa:	0007079b          	sext.w	a5,a4
    7efe:	0007d363          	bgez	a5,7f04 <schedule_rm+0x20a>
    7f02:	4701                	li	a4,0
    7f04:	0007079b          	sext.w	a5,a4
    7f08:	f4f42c23          	sw	a5,-168(s0)
    7f0c:	a89d                	j	7f82 <schedule_rm+0x288>
        }
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    7f0e:	649c                	ld	a5,8(s1)
    7f10:	f4f43823          	sd	a5,-176(s0)
            struct release_queue_entry *rth;
            struct thread *find = NULL;
    7f14:	fa043823          	sd	zero,-80(s0)
            list_for_each_entry(rth, args.release_queue, thread_list) {
    7f18:	689c                	ld	a5,16(s1)
    7f1a:	639c                	ld	a5,0(a5)
    7f1c:	faf43023          	sd	a5,-96(s0)
    7f20:	fa043783          	ld	a5,-96(s0)
    7f24:	17e1                	addi	a5,a5,-8
    7f26:	faf43c23          	sd	a5,-72(s0)
    7f2a:	a825                	j	7f62 <schedule_rm+0x268>
            if (find == NULL || (rth->thrd->period < find->period)) {
    7f2c:	fb043783          	ld	a5,-80(s0)
    7f30:	cb91                	beqz	a5,7f44 <schedule_rm+0x24a>
    7f32:	fb843783          	ld	a5,-72(s0)
    7f36:	639c                	ld	a5,0(a5)
    7f38:	43f8                	lw	a4,68(a5)
    7f3a:	fb043783          	ld	a5,-80(s0)
    7f3e:	43fc                	lw	a5,68(a5)
    7f40:	00f75763          	bge	a4,a5,7f4e <schedule_rm+0x254>
                find = rth->thrd;
    7f44:	fb843783          	ld	a5,-72(s0)
    7f48:	639c                	ld	a5,0(a5)
    7f4a:	faf43823          	sd	a5,-80(s0)
            list_for_each_entry(rth, args.release_queue, thread_list) {
    7f4e:	fb843783          	ld	a5,-72(s0)
    7f52:	679c                	ld	a5,8(a5)
    7f54:	f8f43c23          	sd	a5,-104(s0)
    7f58:	f9843783          	ld	a5,-104(s0)
    7f5c:	17e1                	addi	a5,a5,-8
    7f5e:	faf43c23          	sd	a5,-72(s0)
    7f62:	fb843783          	ld	a5,-72(s0)
    7f66:	00878713          	addi	a4,a5,8
    7f6a:	689c                	ld	a5,16(s1)
    7f6c:	fcf710e3          	bne	a4,a5,7f2c <schedule_rm+0x232>
            }
        }
        r.allocated_time = find->current_deadline - args.current_time;
    7f70:	fb043783          	ld	a5,-80(s0)
    7f74:	4bb8                	lw	a4,80(a5)
    7f76:	409c                	lw	a5,0(s1)
    7f78:	40f707bb          	subw	a5,a4,a5
    7f7c:	2781                	sext.w	a5,a5
    7f7e:	f4f42c23          	sw	a5,-168(s0)
    }

    return r;
    7f82:	f5043783          	ld	a5,-176(s0)
    7f86:	f6f43023          	sd	a5,-160(s0)
    7f8a:	f5843783          	ld	a5,-168(s0)
    7f8e:	f6f43423          	sd	a5,-152(s0)
    7f92:	f6043703          	ld	a4,-160(s0)
    7f96:	f6843783          	ld	a5,-152(s0)
    7f9a:	863a                	mv	a2,a4
    7f9c:	86be                	mv	a3,a5
    7f9e:	8732                	mv	a4,a2
    7fa0:	87b6                	mv	a5,a3
    ...
    7fa2:	853a                	mv	a0,a4
    7fa4:	85be                	mv	a1,a5
    7fa6:	742a                	ld	s0,168(sp)
    7fa8:	748a                	ld	s1,160(sp)
    7faa:	614d                	addi	sp,sp,176
    7fac:	8082                	ret
